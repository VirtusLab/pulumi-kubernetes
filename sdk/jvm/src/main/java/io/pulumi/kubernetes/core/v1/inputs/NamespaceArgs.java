...
public final class NamespaceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NamespaceSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.NamespaceSpecArgs> getSpec() {
    ...
    public NamespaceArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NamespaceSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NamespaceSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NamespaceSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.NamespaceSpecArgs spec) {
