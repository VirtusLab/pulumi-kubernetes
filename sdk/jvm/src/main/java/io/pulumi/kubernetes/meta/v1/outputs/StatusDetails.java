...
public final class StatusDetails {
    private final @Nullable List<io.pulumi.kubernetes.meta.v1.outputs.StatusCause> causes;
    ...
    private StatusDetails(
        @Nullable List<io.pulumi.kubernetes.meta.v1.outputs.StatusCause> causes,
    ...
    public List<io.pulumi.kubernetes.meta.v1.outputs.StatusCause> getCauses() {
    ...
    public static final class Builder {
        private @Nullable List<io.pulumi.kubernetes.meta.v1.outputs.StatusCause> causes;
        ...
        public Builder setCauses(@Nullable List<io.pulumi.kubernetes.meta.v1.outputs.StatusCause> causes) {
            this.causes = causes;
            return this;
        }
