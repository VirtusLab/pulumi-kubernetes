...
public class DaemonSetList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1.outputs.DaemonSet.class})
    private Output<List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSet>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSet>> getItems() {
        return this.items;
    }
