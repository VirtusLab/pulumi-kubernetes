...
public final class NetworkPolicyListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs>> items;

    public Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs>> getItems() {
        return this.items;
    }
    ...
    public NetworkPolicyListArgs(
        ...
        Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.extensions.v1beta1.inputs.NetworkPolicyArgs> items) {
