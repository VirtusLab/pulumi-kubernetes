...
public final class Event {
    ...
    private final @Nullable io.pulumi.kubernetes.events.v1beta1.outputs.EventSeries series;
    ...
    private Event(
        ...
        @Nullable io.pulumi.kubernetes.events.v1beta1.outputs.EventSeries series,
    ...
    public Optional<io.pulumi.kubernetes.events.v1beta1.outputs.EventSeries> getSeries() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.events.v1beta1.outputs.EventSeries series;
        ...
        public Builder setSeries(@Nullable io.pulumi.kubernetes.events.v1beta1.outputs.EventSeries series) {
            this.series = series;
            return this;
        }
