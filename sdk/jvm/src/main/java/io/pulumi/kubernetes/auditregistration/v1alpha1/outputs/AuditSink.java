...
public final class AuditSink {
    ...
    private final @Nullable io.pulumi.kubernetes.auditregistration.v1alpha1.outputs.AuditSinkSpec spec;
    ...
    private AuditSink(
        ...
        @Nullable io.pulumi.kubernetes.auditregistration.v1alpha1.outputs.AuditSinkSpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.auditregistration.v1alpha1.outputs.AuditSinkSpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.auditregistration.v1alpha1.outputs.AuditSinkSpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.auditregistration.v1alpha1.outputs.AuditSinkSpec spec) {
            this.spec = spec;
            return this;
        }
