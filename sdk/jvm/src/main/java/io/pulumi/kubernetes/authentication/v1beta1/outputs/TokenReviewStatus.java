...
package io.pulumi.kubernetes.authentication.v1beta1.outputs;
...
public final class TokenReviewStatus {
    ...
    private final @Nullable io.pulumi.kubernetes.authentication.v1beta1.outputs.UserInfo user;
    ...
    private TokenReviewStatus(
        ...
        @Nullable io.pulumi.kubernetes.authentication.v1beta1.outputs.UserInfo user) {
    ...
    public Optional<io.pulumi.kubernetes.authentication.v1beta1.outputs.UserInfo> getUser() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.authentication.v1beta1.outputs.UserInfo user;
        ...
        public Builder setUser(@Nullable io.pulumi.kubernetes.authentication.v1beta1.outputs.UserInfo user) {
            this.user = user;
            return this;
        }
