...
public final class ServiceSpec {
    ...
    private final @Nullable List<io.pulumi.kubernetes.core.v1.outputs.ServicePort> ports;
    ...
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.SessionAffinityConfig sessionAffinityConfig;
    ...
    private ServiceSpec(
        ...
        @Nullable List<io.pulumi.kubernetes.core.v1.outputs.ServicePort> ports,
        @Nullable Boolean publishNotReadyAddresses,
        @Nullable Map<String,String> selector,
        @Nullable String sessionAffinity,
        @Nullable io.pulumi.kubernetes.core.v1.outputs.SessionAffinityConfig sessionAffinityConfig,
    ...
    public List<io.pulumi.kubernetes.core.v1.outputs.ServicePort> getPorts() {
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.SessionAffinityConfig> getSessionAffinityConfig() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.core.v1.outputs.ServicePort> ports;
        ...
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.SessionAffinityConfig sessionAffinityConfig;
        ...
        public Builder setPorts(@Nullable List<io.pulumi.kubernetes.core.v1.outputs.ServicePort> ports) {
            this.ports = ports;
            return this;
        }
        ...
        public Builder setSessionAffinityConfig(@Nullable io.pulumi.kubernetes.core.v1.outputs.SessionAffinityConfig sessionAffinityConfig) {
            this.sessionAffinityConfig = sessionAffinityConfig;
            return this;
        }
