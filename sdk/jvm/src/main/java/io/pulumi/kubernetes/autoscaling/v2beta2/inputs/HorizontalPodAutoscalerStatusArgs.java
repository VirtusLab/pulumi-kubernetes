...
public final class HorizontalPodAutoscalerStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerConditionArgs>> getConditions() {
        return this.conditions;
    }

    @InputImport(name="currentMetrics")
    private final @Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.MetricStatusArgs>> currentMetrics;

    public Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.MetricStatusArgs>> getCurrentMetrics() {
    ...
    public HorizontalPodAutoscalerStatusArgs(
        Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerConditionArgs>> conditions,
        @Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.MetricStatusArgs>> currentMetrics,
    ...
    public static final class Builder {
        private Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerConditionArgs>> conditions;
        private @Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.MetricStatusArgs>> currentMetrics;
        ...
        public Builder setConditions(Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerConditionArgs>> conditions) {
            this.conditions = Objects.requireNonNull(conditions);
            return this;
        }

        public Builder setConditions(List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerConditionArgs> conditions) {
            this.conditions = Input.of(Objects.requireNonNull(conditions));
            return this;
        }

        public Builder setCurrentMetrics(@Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.MetricStatusArgs>> currentMetrics) {
            this.currentMetrics = currentMetrics;
            return this;
        }

        public Builder setCurrentMetrics(@Nullable List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.MetricStatusArgs> currentMetrics) {
