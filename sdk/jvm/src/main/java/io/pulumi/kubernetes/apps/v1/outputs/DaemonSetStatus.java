...
public final class DaemonSetStatus {
    ...
    private final @Nullable List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSetCondition> conditions;
    ...
    private DaemonSetStatus(
        ...
        @Nullable List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSetCondition> conditions,
    ...
    public List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSetCondition> getConditions() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSetCondition> conditions;
        ...
        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.apps.v1.outputs.DaemonSetCondition> conditions) {
            this.conditions = conditions;
            return this;
        }
