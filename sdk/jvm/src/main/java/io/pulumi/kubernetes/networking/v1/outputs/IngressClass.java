...
public final class IngressClass {
    ...
    private final @Nullable io.pulumi.kubernetes.networking.v1.outputs.IngressClassSpec spec;
    ...
    private IngressClass(
        ...
        @Nullable io.pulumi.kubernetes.networking.v1.outputs.IngressClassSpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.networking.v1.outputs.IngressClassSpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.networking.v1.outputs.IngressClassSpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.networking.v1.outputs.IngressClassSpec spec) {
            this.spec = spec;
            return this;
        }
