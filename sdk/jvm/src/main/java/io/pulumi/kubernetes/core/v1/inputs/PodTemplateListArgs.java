...
public final class PodTemplateListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.core.v1.inputs.PodTemplateArgs>> items;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.PodTemplateArgs>> getItems() {
        return this.items;
    }
    ...
    public PodTemplateListArgs(
        ...
        Input<List<io.pulumi.kubernetes.core.v1.inputs.PodTemplateArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.core.v1.inputs.PodTemplateArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.core.v1.inputs.PodTemplateArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.core.v1.inputs.PodTemplateArgs> items) {
        ...
        public PodTemplateListArgs build() {
            return new PodTemplateListArgs(apiVersion, items, kind, metadata);
        }
    }
}
