...
public final class DaemonSetUpdateStrategyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.RollingUpdateDaemonSetArgs> rollingUpdate;

    public Input<io.pulumi.kubernetes.apps.v1.inputs.RollingUpdateDaemonSetArgs> getRollingUpdate() {
    ...
    public DaemonSetUpdateStrategyArgs(
        @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.RollingUpdateDaemonSetArgs> rollingUpdate,
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.RollingUpdateDaemonSetArgs> rollingUpdate;
        ...
        public Builder setRollingUpdate(@Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.RollingUpdateDaemonSetArgs> rollingUpdate) {
            this.rollingUpdate = rollingUpdate;
            return this;
        }

        public Builder setRollingUpdate(@Nullable io.pulumi.kubernetes.apps.v1.inputs.RollingUpdateDaemonSetArgs rollingUpdate) {
