...
public final class CSIDriverSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.storage.v1.inputs.TokenRequestArgs>> tokenRequests;

    public Input<List<io.pulumi.kubernetes.storage.v1.inputs.TokenRequestArgs>> getTokenRequests() {
    ...
    public CSIDriverSpecArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.storage.v1.inputs.TokenRequestArgs>> tokenRequests,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.storage.v1.inputs.TokenRequestArgs>> tokenRequests;
        ...
        public Builder setTokenRequests(@Nullable Input<List<io.pulumi.kubernetes.storage.v1.inputs.TokenRequestArgs>> tokenRequests) {
            this.tokenRequests = tokenRequests;
            return this;
        }

        public Builder setTokenRequests(@Nullable List<io.pulumi.kubernetes.storage.v1.inputs.TokenRequestArgs> tokenRequests) {
