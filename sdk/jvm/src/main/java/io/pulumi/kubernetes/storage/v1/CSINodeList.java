...
public class CSINodeList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.storage.v1.outputs.CSINode.class})
    private Output<List<io.pulumi.kubernetes.storage.v1.outputs.CSINode>> items;

    public Output<List<io.pulumi.kubernetes.storage.v1.outputs.CSINode>> getItems() {
        return this.items;
    }
