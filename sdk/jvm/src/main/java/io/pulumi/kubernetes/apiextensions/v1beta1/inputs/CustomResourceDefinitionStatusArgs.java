...
public final class CustomResourceDefinitionStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionNamesArgs> acceptedNames;

    public Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionNamesArgs> getAcceptedNames() {
        return this.acceptedNames;
    }

    @InputImport(name="conditions")
    private final @Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionConditionArgs>> getConditions() {
    ...
    public CustomResourceDefinitionStatusArgs(
        Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionNamesArgs> acceptedNames,
        @Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionConditionArgs>> conditions,
    ...
    public static final class Builder {
        private Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionNamesArgs> acceptedNames;
        private @Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionConditionArgs>> conditions;
        ...
        public Builder setAcceptedNames(Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionNamesArgs> acceptedNames) {
            this.acceptedNames = Objects.requireNonNull(acceptedNames);
            return this;
        }

        public Builder setAcceptedNames(io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionNamesArgs acceptedNames) {
            this.acceptedNames = Input.of(Objects.requireNonNull(acceptedNames));
            return this;
        }

        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionConditionArgs> conditions) {
