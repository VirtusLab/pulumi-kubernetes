...
public final class NetworkPolicy {
    ...
    private final @Nullable io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicySpec spec;
    ...
    private NetworkPolicy(
        ...
        @Nullable io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicySpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicySpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicySpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicySpec spec) {
            this.spec = spec;
            return this;
        }
