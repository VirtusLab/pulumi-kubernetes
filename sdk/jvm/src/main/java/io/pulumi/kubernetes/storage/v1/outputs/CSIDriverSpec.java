...
public final class CSIDriverSpec {
    ...
    private final @Nullable List<io.pulumi.kubernetes.storage.v1.outputs.TokenRequest> tokenRequests;
    ...
    private CSIDriverSpec(
        ...
        @Nullable List<io.pulumi.kubernetes.storage.v1.outputs.TokenRequest> tokenRequests,
    ...
    public List<io.pulumi.kubernetes.storage.v1.outputs.TokenRequest> getTokenRequests() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.storage.v1.outputs.TokenRequest> tokenRequests;
        ...
        public Builder setTokenRequests(@Nullable List<io.pulumi.kubernetes.storage.v1.outputs.TokenRequest> tokenRequests) {
            this.tokenRequests = tokenRequests;
            return this;
        }
