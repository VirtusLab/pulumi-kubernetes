...
public class PriorityLevelConfigurationList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfiguration.class})
    private Output<List<io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfiguration>> items;

    public Output<List<io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfiguration>> getItems() {
        return this.items;
    }
