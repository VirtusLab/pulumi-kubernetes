...
public class StorageClassList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.storage.v1beta1.outputs.StorageClass.class})
    private Output<List<io.pulumi.kubernetes.storage.v1beta1.outputs.StorageClass>> items;

    public Output<List<io.pulumi.kubernetes.storage.v1beta1.outputs.StorageClass>> getItems() {
        return this.items;
    }
