...
public class LimitRange extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec> getSpec() {
        return this.spec;
    }
