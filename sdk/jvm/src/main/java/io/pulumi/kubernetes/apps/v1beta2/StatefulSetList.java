...
public class StatefulSetList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1beta2.outputs.StatefulSet.class})
    private Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.StatefulSet>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.StatefulSet>> getItems() {
        return this.items;
    }
