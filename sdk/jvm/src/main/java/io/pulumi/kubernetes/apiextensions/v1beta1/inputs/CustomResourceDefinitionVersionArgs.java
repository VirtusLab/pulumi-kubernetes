...
public final class CustomResourceDefinitionVersionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceValidationArgs> schema;

    public Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceValidationArgs> getSchema() {
    ...
    public CustomResourceDefinitionVersionArgs(
        ...
        Input<String> name,
        @Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceValidationArgs> schema,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceValidationArgs> schema;
        ...
        public Builder setSchema(@Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceValidationArgs> schema) {
            this.schema = schema;
            return this;
        }

        public Builder setSchema(@Nullable io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceValidationArgs schema) {
