...
public class HorizontalPodAutoscalerList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscaler.class})
    private Output<List<io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscaler>> items;

    public Output<List<io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscaler>> getItems() {
        return this.items;
    }
