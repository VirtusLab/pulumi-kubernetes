...
public class CSINode extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.storage.v1.outputs.CSINodeSpec.class, parameters={})
    private Output<io.pulumi.kubernetes.storage.v1.outputs.CSINodeSpec> spec;

    public Output<io.pulumi.kubernetes.storage.v1.outputs.CSINodeSpec> getSpec() {
        return this.spec;
    }
