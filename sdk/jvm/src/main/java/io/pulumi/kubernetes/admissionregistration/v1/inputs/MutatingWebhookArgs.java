...
public final class MutatingWebhookArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.admissionregistration.v1.inputs.WebhookClientConfigArgs> clientConfig;

    public Input<io.pulumi.kubernetes.admissionregistration.v1.inputs.WebhookClientConfigArgs> getClientConfig() {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.RuleWithOperationsArgs>> rules;

    public Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.RuleWithOperationsArgs>> getRules() {
    ...
    public MutatingWebhookArgs(
        ...
        Input<io.pulumi.kubernetes.admissionregistration.v1.inputs.WebhookClientConfigArgs> clientConfig,
        ...
        @Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.RuleWithOperationsArgs>> rules,
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.admissionregistration.v1.inputs.WebhookClientConfigArgs> clientConfig;
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.RuleWithOperationsArgs>> rules;
        ...
        public Builder setClientConfig(Input<io.pulumi.kubernetes.admissionregistration.v1.inputs.WebhookClientConfigArgs> clientConfig) {
            this.clientConfig = Objects.requireNonNull(clientConfig);
            return this;
        }

        public Builder setClientConfig(io.pulumi.kubernetes.admissionregistration.v1.inputs.WebhookClientConfigArgs clientConfig) {
        ...
        public Builder setRules(@Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.RuleWithOperationsArgs>> rules) {
            this.rules = rules;
            return this;
        }

        public Builder setRules(@Nullable List<io.pulumi.kubernetes.admissionregistration.v1.inputs.RuleWithOperationsArgs> rules) {
