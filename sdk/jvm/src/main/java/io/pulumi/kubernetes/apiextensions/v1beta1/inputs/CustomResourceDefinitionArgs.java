...
public final class CustomResourceDefinitionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionSpecArgs> spec;

    public Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public CustomResourceDefinitionArgs(
        ...
        Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceDefinitionSpecArgs spec) {
