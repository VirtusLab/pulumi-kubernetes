...
public final class VolumeAttachmentStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> attachError;

    public Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> getAttachError() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> detachError;

    public Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> getDetachError() {
        return this.detachError == null ? Input.empty() : this.detachError;
    }

    public VolumeAttachmentStatusArgs(
        @Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> attachError,
        Input<Boolean> attached,
        @Nullable Input<Map<String,String>> attachmentMetadata,
        @Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> detachError) {
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> attachError;
        private Input<Boolean> attached;
        private @Nullable Input<Map<String,String>> attachmentMetadata;
        private @Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> detachError;
        ...
        public Builder setAttachError(@Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> attachError) {
            this.attachError = attachError;
            return this;
        }

        public Builder setAttachError(@Nullable io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs attachError) {
        ...
        public Builder setDetachError(@Nullable Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs> detachError) {
            this.detachError = detachError;
            return this;
        }

        public Builder setDetachError(@Nullable io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeErrorArgs detachError) {
