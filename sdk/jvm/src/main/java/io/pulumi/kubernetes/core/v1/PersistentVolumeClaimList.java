...
public class PersistentVolumeClaimList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaim.class})
    private Output<List<io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaim>> items;

    public Output<List<io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaim>> getItems() {
        return this.items;
    }
