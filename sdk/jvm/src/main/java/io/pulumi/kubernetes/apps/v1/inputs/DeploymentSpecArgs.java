...
public final class DeploymentSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DeploymentStrategyArgs> strategy;

    public Input<io.pulumi.kubernetes.apps.v1.inputs.DeploymentStrategyArgs> getStrategy() {
    ...
    public DeploymentSpecArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DeploymentStrategyArgs> strategy,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DeploymentStrategyArgs> strategy;
        ...
        public Builder setStrategy(@Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DeploymentStrategyArgs> strategy) {
            this.strategy = strategy;
            return this;
        }

        public Builder setStrategy(@Nullable io.pulumi.kubernetes.apps.v1.inputs.DeploymentStrategyArgs strategy) {
