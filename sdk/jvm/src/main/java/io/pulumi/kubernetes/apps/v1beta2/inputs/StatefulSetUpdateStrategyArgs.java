...
public final class StatefulSetUpdateStrategyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.RollingUpdateStatefulSetStrategyArgs> rollingUpdate;

    public Input<io.pulumi.kubernetes.apps.v1beta2.inputs.RollingUpdateStatefulSetStrategyArgs> getRollingUpdate() {
    ...
    public StatefulSetUpdateStrategyArgs(
        @Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.RollingUpdateStatefulSetStrategyArgs> rollingUpdate,
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.RollingUpdateStatefulSetStrategyArgs> rollingUpdate;
        ...
        public Builder setRollingUpdate(@Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.RollingUpdateStatefulSetStrategyArgs> rollingUpdate) {
            this.rollingUpdate = rollingUpdate;
            return this;
        }

        public Builder setRollingUpdate(@Nullable io.pulumi.kubernetes.apps.v1beta2.inputs.RollingUpdateStatefulSetStrategyArgs rollingUpdate) {
