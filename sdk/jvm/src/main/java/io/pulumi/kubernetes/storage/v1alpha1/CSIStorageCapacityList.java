...
public class CSIStorageCapacityList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.storage.v1alpha1.outputs.CSIStorageCapacity.class})
    private Output<List<io.pulumi.kubernetes.storage.v1alpha1.outputs.CSIStorageCapacity>> items;

    public Output<List<io.pulumi.kubernetes.storage.v1alpha1.outputs.CSIStorageCapacity>> getItems() {
        return this.items;
    }
