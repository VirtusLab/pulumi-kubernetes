...
package io.pulumi.kubernetes.meta.v1;
...
import io.pulumi.kubernetes.meta.v1.inputs.*;

@ResourceType(type="kubernetes:meta/v1:Status")
public class Status extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="details", type=io.pulumi.kubernetes.meta.v1.outputs.StatusDetails.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.meta.v1.outputs.StatusDetails> details;

    public Output</* @Nullable */ io.pulumi.kubernetes.meta.v1.outputs.StatusDetails> getDetails() {
        return this.details;
    }
