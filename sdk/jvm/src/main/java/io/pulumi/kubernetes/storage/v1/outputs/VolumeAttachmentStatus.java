...
public final class VolumeAttachmentStatus {
    private final @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError attachError;
    private final Boolean attached;
    private final @Nullable Map<String,String> attachmentMetadata;
    private final @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError detachError;

    @OutputCustomType.Constructor({"attachError","attached","attachmentMetadata","detachError"})
    private VolumeAttachmentStatus(
        @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError attachError,
        Boolean attached,
        @Nullable Map<String,String> attachmentMetadata,
        @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError detachError) {
    ...
    public Optional<io.pulumi.kubernetes.storage.v1.outputs.VolumeError> getAttachError() {
    ...
    public Optional<io.pulumi.kubernetes.storage.v1.outputs.VolumeError> getDetachError() {
    ...
    public static final class Builder {
        private @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError attachError;
        private Boolean attached;
        private @Nullable Map<String,String> attachmentMetadata;
        private @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError detachError;
        ...
        public Builder setAttachError(@Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError attachError) {
            this.attachError = attachError;
            return this;
        }
        ...
        public Builder setDetachError(@Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeError detachError) {
            this.detachError = detachError;
            return this;
        }
