...
public class ControllerRevisionList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1beta2.outputs.ControllerRevision.class})
    private Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.ControllerRevision>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.ControllerRevision>> getItems() {
        return this.items;
    }
