...
package io.pulumi.kubernetes.scheduling.v1beta1;
...
import io.pulumi.kubernetes.scheduling.v1beta1.inputs.*;
...
public class PriorityClassList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.scheduling.v1beta1.outputs.PriorityClass.class})
    private Output<List<io.pulumi.kubernetes.scheduling.v1beta1.outputs.PriorityClass>> items;

    public Output<List<io.pulumi.kubernetes.scheduling.v1beta1.outputs.PriorityClass>> getItems() {
        return this.items;
    }
