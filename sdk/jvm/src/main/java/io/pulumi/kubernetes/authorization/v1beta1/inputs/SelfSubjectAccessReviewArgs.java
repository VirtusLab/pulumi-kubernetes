...
public final class SelfSubjectAccessReviewArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SelfSubjectAccessReviewSpecArgs> spec;

    public Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SelfSubjectAccessReviewSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public SelfSubjectAccessReviewArgs(
        ...
        Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SelfSubjectAccessReviewSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SelfSubjectAccessReviewSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SelfSubjectAccessReviewSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.authorization.v1beta1.inputs.SelfSubjectAccessReviewSpecArgs spec) {
