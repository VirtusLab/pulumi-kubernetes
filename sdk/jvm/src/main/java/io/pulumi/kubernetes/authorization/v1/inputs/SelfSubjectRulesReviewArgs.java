...
public final class SelfSubjectRulesReviewArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.authorization.v1.inputs.SelfSubjectRulesReviewSpecArgs> spec;

    public Input<io.pulumi.kubernetes.authorization.v1.inputs.SelfSubjectRulesReviewSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public SelfSubjectRulesReviewArgs(
        ...
        Input<io.pulumi.kubernetes.authorization.v1.inputs.SelfSubjectRulesReviewSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.authorization.v1.inputs.SelfSubjectRulesReviewSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.authorization.v1.inputs.SelfSubjectRulesReviewSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.authorization.v1.inputs.SelfSubjectRulesReviewSpecArgs spec) {
