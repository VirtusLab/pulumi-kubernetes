...
public final class ClusterRoleBindingListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.rbac.v1.inputs.ClusterRoleBindingArgs>> items;

    public Input<List<io.pulumi.kubernetes.rbac.v1.inputs.ClusterRoleBindingArgs>> getItems() {
        return this.items;
    }
    ...
    public ClusterRoleBindingListArgs(
        ...
        Input<List<io.pulumi.kubernetes.rbac.v1.inputs.ClusterRoleBindingArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.rbac.v1.inputs.ClusterRoleBindingArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.rbac.v1.inputs.ClusterRoleBindingArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.rbac.v1.inputs.ClusterRoleBindingArgs> items) {
