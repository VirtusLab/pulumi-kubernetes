...
public final class VolumeAttachmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSpecArgs> spec;

    public Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public VolumeAttachmentArgs(
        ...
        Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSpecArgs spec) {
