...
public final class RuntimeClassArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecArgs> spec;

    public Input<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public RuntimeClassArgs(
        ...
        Input<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassSpecArgs spec) {
