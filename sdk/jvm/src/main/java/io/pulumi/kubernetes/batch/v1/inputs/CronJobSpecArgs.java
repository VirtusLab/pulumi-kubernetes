...
public final class CronJobSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.batch.v1.inputs.JobTemplateSpecArgs> jobTemplate;

    public Input<io.pulumi.kubernetes.batch.v1.inputs.JobTemplateSpecArgs> getJobTemplate() {
    ...
    public CronJobSpecArgs(
        ...
        Input<io.pulumi.kubernetes.batch.v1.inputs.JobTemplateSpecArgs> jobTemplate,
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.batch.v1.inputs.JobTemplateSpecArgs> jobTemplate;
        ...
        public Builder setJobTemplate(Input<io.pulumi.kubernetes.batch.v1.inputs.JobTemplateSpecArgs> jobTemplate) {
            this.jobTemplate = Objects.requireNonNull(jobTemplate);
            return this;
        }

        public Builder setJobTemplate(io.pulumi.kubernetes.batch.v1.inputs.JobTemplateSpecArgs jobTemplate) {
