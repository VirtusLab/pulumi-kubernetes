...
public final class ReplicationControllerStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerConditionArgs>> getConditions() {
    ...
    public ReplicationControllerStatusArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerConditionArgs>> conditions,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerConditionArgs>> conditions;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerConditionArgs> conditions) {
