...
public final class PodStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.PodConditionArgs>> getConditions() {
        return this.conditions == null ? Input.empty() : this.conditions;
    }

    @InputImport(name="containerStatuses")
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> containerStatuses;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> getContainerStatuses() {
        return this.containerStatuses == null ? Input.empty() : this.containerStatuses;
    }

    @InputImport(name="ephemeralContainerStatuses")
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> ephemeralContainerStatuses;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> getEphemeralContainerStatuses() {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> initContainerStatuses;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> getInitContainerStatuses() {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodIPArgs>> podIPs;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.PodIPArgs>> getPodIPs() {
    ...
    public PodStatusArgs(
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodConditionArgs>> conditions,
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> containerStatuses,
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> ephemeralContainerStatuses,
        @Nullable Input<String> hostIP,
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> initContainerStatuses,
        @Nullable Input<String> message,
        @Nullable Input<String> nominatedNodeName,
        @Nullable Input<String> phase,
        @Nullable Input<String> podIP,
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodIPArgs>> podIPs,
    ...
    public static final class Builder {
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodConditionArgs>> conditions;
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> containerStatuses;
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> ephemeralContainerStatuses;
        private @Nullable Input<String> hostIP;
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> initContainerStatuses;
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodIPArgs>> podIPs;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.PodConditionArgs> conditions) {
            this.conditions = Input.ofNullable(conditions);
            return this;
        }

        public Builder setContainerStatuses(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> containerStatuses) {
            this.containerStatuses = containerStatuses;
            return this;
        }

        public Builder setContainerStatuses(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs> containerStatuses) {
            this.containerStatuses = Input.ofNullable(containerStatuses);
            return this;
        }

        public Builder setEphemeralContainerStatuses(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> ephemeralContainerStatuses) {
            this.ephemeralContainerStatuses = ephemeralContainerStatuses;
            return this;
        }

        public Builder setEphemeralContainerStatuses(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs> ephemeralContainerStatuses) {
        ...
        public Builder setInitContainerStatuses(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs>> initContainerStatuses) {
            this.initContainerStatuses = initContainerStatuses;
            return this;
        }

        public Builder setInitContainerStatuses(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.ContainerStatusArgs> initContainerStatuses) {
        ...
        public Builder setPodIPs(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.PodIPArgs>> podIPs) {
            this.podIPs = podIPs;
            return this;
        }

        public Builder setPodIPs(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.PodIPArgs> podIPs) {
