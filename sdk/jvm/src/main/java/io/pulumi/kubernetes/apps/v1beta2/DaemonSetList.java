...
@ResourceType(type="kubernetes:apps/v1beta2:DaemonSetList")
public class DaemonSetList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1beta2.outputs.DaemonSet.class})
    private Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.DaemonSet>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.DaemonSet>> getItems() {
        return this.items;
    }
    ...
    public DaemonSetList(String name, DaemonSetListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:DaemonSetList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
