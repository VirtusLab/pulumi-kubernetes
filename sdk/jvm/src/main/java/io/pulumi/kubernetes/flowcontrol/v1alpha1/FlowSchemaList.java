...
public class FlowSchemaList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.FlowSchema.class})
    private Output<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.FlowSchema>> items;

    public Output<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.FlowSchema>> getItems() {
        return this.items;
    }
