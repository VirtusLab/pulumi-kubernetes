...
public final class NetworkPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.NetworkPolicySpecArgs> spec;

    public Input<io.pulumi.kubernetes.networking.v1.inputs.NetworkPolicySpecArgs> getSpec() {
    ...
    public NetworkPolicyArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.NetworkPolicySpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.NetworkPolicySpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.NetworkPolicySpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.networking.v1.inputs.NetworkPolicySpecArgs spec) {
