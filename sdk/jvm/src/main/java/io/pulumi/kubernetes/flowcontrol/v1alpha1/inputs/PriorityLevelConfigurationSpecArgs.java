...
public final class PriorityLevelConfigurationSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.LimitedPriorityLevelConfigurationArgs> limited;

    public Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.LimitedPriorityLevelConfigurationArgs> getLimited() {
    ...
    public PriorityLevelConfigurationSpecArgs(
        @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.LimitedPriorityLevelConfigurationArgs> limited,
        Input<String> type) {
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.LimitedPriorityLevelConfigurationArgs> limited;
        ...
        public Builder setLimited(@Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.LimitedPriorityLevelConfigurationArgs> limited) {
            this.limited = limited;
            return this;
        }

        public Builder setLimited(@Nullable io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.LimitedPriorityLevelConfigurationArgs limited) {
