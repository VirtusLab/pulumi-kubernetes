...
public final class VolumeAttachmentSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSourceArgs> source;

    public Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSourceArgs> getSource() {
        return this.source;
    }
    ...
    public VolumeAttachmentSpecArgs(
        ...
        Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSourceArgs> source) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSourceArgs> source;
        ...
        public Builder setSource(Input<io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSourceArgs> source) {
            this.source = Objects.requireNonNull(source);
            return this;
        }

        public Builder setSource(io.pulumi.kubernetes.storage.v1beta1.inputs.VolumeAttachmentSourceArgs source) {
