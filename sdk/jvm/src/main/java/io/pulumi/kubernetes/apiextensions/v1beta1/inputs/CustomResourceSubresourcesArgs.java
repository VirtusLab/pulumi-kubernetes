...
public final class CustomResourceSubresourcesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceSubresourceScaleArgs> scale;

    public Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceSubresourceScaleArgs> getScale() {
    ...
    public CustomResourceSubresourcesArgs(
        @Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceSubresourceScaleArgs> scale,
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceSubresourceScaleArgs> scale;
        ...
        public Builder setScale(@Nullable Input<io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceSubresourceScaleArgs> scale) {
            this.scale = scale;
            return this;
        }

        public Builder setScale(@Nullable io.pulumi.kubernetes.apiextensions.v1beta1.inputs.CustomResourceSubresourceScaleArgs scale) {
