...
public final class TokenRequestArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.authentication.v1.inputs.TokenRequestSpecArgs> spec;

    public Input<io.pulumi.kubernetes.authentication.v1.inputs.TokenRequestSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public TokenRequestArgs(
        ...
        Input<io.pulumi.kubernetes.authentication.v1.inputs.TokenRequestSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.authentication.v1.inputs.TokenRequestSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.authentication.v1.inputs.TokenRequestSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.authentication.v1.inputs.TokenRequestSpecArgs spec) {
