...
public class NodeList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.core.v1.outputs.Node.class})
    private Output<List<io.pulumi.kubernetes.core.v1.outputs.Node>> items;

    public Output<List<io.pulumi.kubernetes.core.v1.outputs.Node>> getItems() {
        return this.items;
    }
