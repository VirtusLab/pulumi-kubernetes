...
public final class StatefulSetSpec {
    ...
    private final @Nullable io.pulumi.kubernetes.apps.v1.outputs.StatefulSetUpdateStrategy updateStrategy;
    ...
    private StatefulSetSpec(
        ...
        @Nullable io.pulumi.kubernetes.apps.v1.outputs.StatefulSetUpdateStrategy updateStrategy,
    ...
    public Optional<io.pulumi.kubernetes.apps.v1.outputs.StatefulSetUpdateStrategy> getUpdateStrategy() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.apps.v1.outputs.StatefulSetUpdateStrategy updateStrategy;
        ...
        public Builder setUpdateStrategy(@Nullable io.pulumi.kubernetes.apps.v1.outputs.StatefulSetUpdateStrategy updateStrategy) {
            this.updateStrategy = updateStrategy;
            return this;
        }
