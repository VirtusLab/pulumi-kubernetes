...
public final class WebhookClientConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ServiceReferenceArgs> service;

    public Input<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ServiceReferenceArgs> getService() {
    ...
    public WebhookClientConfigArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ServiceReferenceArgs> service,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ServiceReferenceArgs> service;
        ...
        public Builder setService(@Nullable Input<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ServiceReferenceArgs> service) {
            this.service = service;
            return this;
        }

        public Builder setService(@Nullable io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.ServiceReferenceArgs service) {
