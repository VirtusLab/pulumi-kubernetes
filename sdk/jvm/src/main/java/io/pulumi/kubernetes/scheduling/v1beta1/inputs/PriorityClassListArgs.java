...
package io.pulumi.kubernetes.scheduling.v1beta1.inputs;
...
public final class PriorityClassListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.scheduling.v1beta1.inputs.PriorityClassArgs>> items;

    public Input<List<io.pulumi.kubernetes.scheduling.v1beta1.inputs.PriorityClassArgs>> getItems() {
        return this.items;
    }
    ...
    public PriorityClassListArgs(
        ...
        Input<List<io.pulumi.kubernetes.scheduling.v1beta1.inputs.PriorityClassArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.scheduling.v1beta1.inputs.PriorityClassArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.scheduling.v1beta1.inputs.PriorityClassArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.scheduling.v1beta1.inputs.PriorityClassArgs> items) {
