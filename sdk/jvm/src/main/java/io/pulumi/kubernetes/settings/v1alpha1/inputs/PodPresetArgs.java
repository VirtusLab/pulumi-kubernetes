...
public final class PodPresetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.settings.v1alpha1.inputs.PodPresetSpecArgs> spec;

    public Input<io.pulumi.kubernetes.settings.v1alpha1.inputs.PodPresetSpecArgs> getSpec() {
    ...
    public PodPresetArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.settings.v1alpha1.inputs.PodPresetSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.settings.v1alpha1.inputs.PodPresetSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.settings.v1alpha1.inputs.PodPresetSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.settings.v1alpha1.inputs.PodPresetSpecArgs spec) {
