...
public class CertificateSigningRequest extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.certificates.v1.outputs.CertificateSigningRequestSpec.class, parameters={})
    private Output<io.pulumi.kubernetes.certificates.v1.outputs.CertificateSigningRequestSpec> spec;

    public Output<io.pulumi.kubernetes.certificates.v1.outputs.CertificateSigningRequestSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.certificates.v1.outputs.CertificateSigningRequestStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.certificates.v1.outputs.CertificateSigningRequestStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.certificates.v1.outputs.CertificateSigningRequestStatus> getStatus() {
        return this.status;
    }
