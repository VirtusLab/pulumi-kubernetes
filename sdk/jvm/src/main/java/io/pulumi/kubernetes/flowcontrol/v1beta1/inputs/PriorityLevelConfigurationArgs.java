...
public final class PriorityLevelConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.PriorityLevelConfigurationSpecArgs> spec;

    public Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.PriorityLevelConfigurationSpecArgs> getSpec() {
    ...
    public PriorityLevelConfigurationArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.PriorityLevelConfigurationSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.PriorityLevelConfigurationSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.PriorityLevelConfigurationSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.PriorityLevelConfigurationSpecArgs spec) {
