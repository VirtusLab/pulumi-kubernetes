...
public final class IngressClassSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassParametersReferenceArgs> parameters;

    public Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassParametersReferenceArgs> getParameters() {
        return this.parameters == null ? Input.empty() : this.parameters;
    }

    public IngressClassSpecArgs(
        @Nullable Input<String> controller,
        @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassParametersReferenceArgs> parameters) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassParametersReferenceArgs> parameters;
        ...
        public Builder setParameters(@Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassParametersReferenceArgs> parameters) {
            this.parameters = parameters;
            return this;
        }

        public Builder setParameters(@Nullable io.pulumi.kubernetes.networking.v1.inputs.IngressClassParametersReferenceArgs parameters) {
