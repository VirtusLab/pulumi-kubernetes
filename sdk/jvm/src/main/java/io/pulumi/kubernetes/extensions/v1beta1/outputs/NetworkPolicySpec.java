...
public final class NetworkPolicySpec {
    private final @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyEgressRule> egress;
    private final @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyIngressRule> ingress;
    ...
    private NetworkPolicySpec(
        @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyEgressRule> egress,
        @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyIngressRule> ingress,
    ...
    public List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyEgressRule> getEgress() {
        return this.egress == null ? List.of() : this.egress;
    }
    public List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyIngressRule> getIngress() {
    ...
    public static final class Builder {
        private @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyEgressRule> egress;
        private @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyIngressRule> ingress;
        ...
        public Builder setEgress(@Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyEgressRule> egress) {
            this.egress = egress;
            return this;
        }

        public Builder setIngress(@Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.NetworkPolicyIngressRule> ingress) {
            this.ingress = ingress;
            return this;
        }
