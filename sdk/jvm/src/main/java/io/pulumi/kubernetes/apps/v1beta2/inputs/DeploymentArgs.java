...
public final class DeploymentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentSpecArgs> spec;

    public Input<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentSpecArgs> getSpec() {
    ...
    public DeploymentArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentSpecArgs spec) {
