...
public class PersistentVolumeClaim extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaimSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaimSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaimSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaimStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaimStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.PersistentVolumeClaimStatus> getStatus() {
        return this.status;
    }
