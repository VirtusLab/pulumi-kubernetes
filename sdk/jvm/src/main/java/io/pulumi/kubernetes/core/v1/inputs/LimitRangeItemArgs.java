...
public final class LimitRangeItemArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<Map<String,String>> getDefault() {
    ...
    public static final class Builder {
        ...
        public Builder setDefault(@Nullable Input<Map<String,String>> $default) {
            this.$default = $default;
            return this;
        }

        public Builder setDefault(@Nullable Map<String,String> $default) {
