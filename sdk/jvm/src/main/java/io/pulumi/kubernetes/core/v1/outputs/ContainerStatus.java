...
public final class ContainerStatus {
    ...
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState lastState;
    private final String name;
    private final Boolean ready;
    private final Integer restartCount;
    private final @Nullable Boolean started;
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState state;
    ...
    private ContainerStatus(
        ...
        String image,
        String imageID,
        @Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState lastState,
        String name,
        Boolean ready,
        Integer restartCount,
        @Nullable Boolean started,
        @Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState state) {
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.ContainerState> getLastState() {
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.ContainerState> getState() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState lastState;
        private String name;
        private Boolean ready;
        private Integer restartCount;
        private @Nullable Boolean started;
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState state;
        ...
        public Builder setLastState(@Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState lastState) {
            this.lastState = lastState;
            return this;
        }
        ...
        public Builder setState(@Nullable io.pulumi.kubernetes.core.v1.outputs.ContainerState state) {
            this.state = state;
            return this;
        }
