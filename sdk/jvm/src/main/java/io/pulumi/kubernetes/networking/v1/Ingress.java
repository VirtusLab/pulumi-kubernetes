...
public class Ingress extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.networking.v1.outputs.IngressSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.networking.v1.outputs.IngressSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.networking.v1.outputs.IngressSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.networking.v1.outputs.IngressStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.networking.v1.outputs.IngressStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.networking.v1.outputs.IngressStatus> getStatus() {
        return this.status;
    }
