...
package io.pulumi.kubernetes.coordination.v1beta1.inputs;
...
public final class LeaseArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.coordination.v1beta1.inputs.LeaseSpecArgs> spec;

    public Input<io.pulumi.kubernetes.coordination.v1beta1.inputs.LeaseSpecArgs> getSpec() {
    ...
    public LeaseArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.coordination.v1beta1.inputs.LeaseSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.coordination.v1beta1.inputs.LeaseSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.coordination.v1beta1.inputs.LeaseSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.coordination.v1beta1.inputs.LeaseSpecArgs spec) {
