...
public class PodSecurityPolicy extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.extensions.v1beta1.outputs.PodSecurityPolicySpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.extensions.v1beta1.outputs.PodSecurityPolicySpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.extensions.v1beta1.outputs.PodSecurityPolicySpec> getSpec() {
        return this.spec;
    }
