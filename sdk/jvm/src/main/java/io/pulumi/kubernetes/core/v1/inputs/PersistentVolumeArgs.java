...
public final class PersistentVolumeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeSpecArgs> getSpec() {
    ...
    public PersistentVolumeArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeSpecArgs spec) {
