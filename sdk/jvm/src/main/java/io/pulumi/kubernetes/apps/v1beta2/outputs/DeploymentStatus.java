...
public final class DeploymentStatus {
    ...
    private final @Nullable List<io.pulumi.kubernetes.apps.v1beta2.outputs.DeploymentCondition> conditions;
    ...
    private DeploymentStatus(
        ...
        @Nullable List<io.pulumi.kubernetes.apps.v1beta2.outputs.DeploymentCondition> conditions,
    ...
    public List<io.pulumi.kubernetes.apps.v1beta2.outputs.DeploymentCondition> getConditions() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.apps.v1beta2.outputs.DeploymentCondition> conditions;
        ...
        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.apps.v1beta2.outputs.DeploymentCondition> conditions) {
            this.conditions = conditions;
            return this;
        }
