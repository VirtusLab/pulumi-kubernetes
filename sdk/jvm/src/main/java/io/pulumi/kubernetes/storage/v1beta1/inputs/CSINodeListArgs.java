...
public final class CSINodeListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.storage.v1beta1.inputs.CSINodeArgs>> items;

    public Input<List<io.pulumi.kubernetes.storage.v1beta1.inputs.CSINodeArgs>> getItems() {
        return this.items;
    }
    ...
    public CSINodeListArgs(
        ...
        Input<List<io.pulumi.kubernetes.storage.v1beta1.inputs.CSINodeArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.storage.v1beta1.inputs.CSINodeArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.storage.v1beta1.inputs.CSINodeArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.storage.v1beta1.inputs.CSINodeArgs> items) {
