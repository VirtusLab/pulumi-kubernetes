...
public class RoleList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.rbac.v1alpha1.outputs.Role.class})
    private Output<List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Role>> items;

    public Output<List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Role>> getItems() {
        return this.items;
    }
