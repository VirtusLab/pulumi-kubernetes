...
public final class RuntimeClassListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs>> items;

    public Input<List<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs>> getItems() {
        return this.items;
    }
    ...
    public RuntimeClassListArgs(
        ...
        Input<List<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.node.v1alpha1.inputs.RuntimeClassArgs> items) {
