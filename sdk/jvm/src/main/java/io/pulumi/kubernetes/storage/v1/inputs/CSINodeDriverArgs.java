...
public final class CSINodeDriverArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.storage.v1.inputs.VolumeNodeResourcesArgs> allocatable;

    public Input<io.pulumi.kubernetes.storage.v1.inputs.VolumeNodeResourcesArgs> getAllocatable() {
    ...
    public CSINodeDriverArgs(
        @Nullable Input<io.pulumi.kubernetes.storage.v1.inputs.VolumeNodeResourcesArgs> allocatable,
        Input<String> name,
        Input<String> nodeID,
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.storage.v1.inputs.VolumeNodeResourcesArgs> allocatable;
        ...
        public Builder setAllocatable(@Nullable Input<io.pulumi.kubernetes.storage.v1.inputs.VolumeNodeResourcesArgs> allocatable) {
            this.allocatable = allocatable;
            return this;
        }

        public Builder setAllocatable(@Nullable io.pulumi.kubernetes.storage.v1.inputs.VolumeNodeResourcesArgs allocatable) {
