...
public final class PersistentVolumeClaimArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimSpecArgs> spec;
    ...
    public PersistentVolumeClaimArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimSpecArgs spec) {
