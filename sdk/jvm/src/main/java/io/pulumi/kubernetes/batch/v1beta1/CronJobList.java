...
public class CronJobList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.batch.v1beta1.outputs.CronJob.class})
    private Output<List<io.pulumi.kubernetes.batch.v1beta1.outputs.CronJob>> items;

    public Output<List<io.pulumi.kubernetes.batch.v1beta1.outputs.CronJob>> getItems() {
        return this.items;
    }
