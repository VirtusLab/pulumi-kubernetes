...
public final class PodSecurityPolicy {
    ...
    private final @Nullable io.pulumi.kubernetes.policy.v1beta1.outputs.PodSecurityPolicySpec spec;
    ...
    private PodSecurityPolicy(
        ...
        @Nullable io.pulumi.kubernetes.policy.v1beta1.outputs.PodSecurityPolicySpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.policy.v1beta1.outputs.PodSecurityPolicySpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.policy.v1beta1.outputs.PodSecurityPolicySpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.policy.v1beta1.outputs.PodSecurityPolicySpec spec) {
            this.spec = spec;
            return this;
        }
