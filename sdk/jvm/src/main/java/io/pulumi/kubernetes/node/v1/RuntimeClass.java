...
package io.pulumi.kubernetes.node.v1;
...
import io.pulumi.kubernetes.node.v1.inputs.*;
...
public class RuntimeClass extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="overhead", type=io.pulumi.kubernetes.node.v1.outputs.Overhead.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.node.v1.outputs.Overhead> overhead;

    public Output</* @Nullable */ io.pulumi.kubernetes.node.v1.outputs.Overhead> getOverhead() {
        return this.overhead;
    }
    @OutputExport(name="scheduling", type=io.pulumi.kubernetes.node.v1.outputs.Scheduling.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.node.v1.outputs.Scheduling> scheduling;

    public Output</* @Nullable */ io.pulumi.kubernetes.node.v1.outputs.Scheduling> getScheduling() {
