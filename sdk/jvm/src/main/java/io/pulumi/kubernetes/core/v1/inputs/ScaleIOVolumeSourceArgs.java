...
public final class ScaleIOVolumeSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.core.v1.inputs.LocalObjectReferenceArgs> secretRef;
    ...
    public ScaleIOVolumeSourceArgs(
        ...
        Input<io.pulumi.kubernetes.core.v1.inputs.LocalObjectReferenceArgs> secretRef,
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.core.v1.inputs.LocalObjectReferenceArgs> secretRef;
        ...
        public Builder setSecretRef(Input<io.pulumi.kubernetes.core.v1.inputs.LocalObjectReferenceArgs> secretRef) {
            this.secretRef = Objects.requireNonNull(secretRef);
            return this;
        }

        public Builder setSecretRef(io.pulumi.kubernetes.core.v1.inputs.LocalObjectReferenceArgs secretRef) {
