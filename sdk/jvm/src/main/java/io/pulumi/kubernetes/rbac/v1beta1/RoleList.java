...
@ResourceType(type="kubernetes:rbac.authorization.k8s.io/v1beta1:RoleList")
public class RoleList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.rbac.v1beta1.outputs.Role.class})
    private Output<List<io.pulumi.kubernetes.rbac.v1beta1.outputs.Role>> items;

    public Output<List<io.pulumi.kubernetes.rbac.v1beta1.outputs.Role>> getItems() {
        return this.items;
    }
    ...
    public RoleList(String name, RoleListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
