...
public final class ValidatingWebhookConfiguration {
    ...
    private final @Nullable List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhook> webhooks;
    ...
    private ValidatingWebhookConfiguration(
        ...
        @Nullable List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhook> webhooks) {
    ...
    public List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhook> getWebhooks() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhook> webhooks;
        ...
        public Builder setWebhooks(@Nullable List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhook> webhooks) {
            this.webhooks = webhooks;
            return this;
        }
