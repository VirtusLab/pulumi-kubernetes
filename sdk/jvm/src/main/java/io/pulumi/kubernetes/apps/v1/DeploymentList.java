...
public class DeploymentList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1.outputs.Deployment.class})
    private Output<List<io.pulumi.kubernetes.apps.v1.outputs.Deployment>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1.outputs.Deployment>> getItems() {
        return this.items;
    }
