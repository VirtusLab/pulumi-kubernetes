...
public final class HorizontalPodAutoscalerSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.MetricSpecArgs>> metrics;

    public Input<List<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.MetricSpecArgs>> getMetrics() {
    ...
    private final Input<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef;

    public Input<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.CrossVersionObjectReferenceArgs> getScaleTargetRef() {
        return this.scaleTargetRef;
    }

    public HorizontalPodAutoscalerSpecArgs(
        Input<Integer> maxReplicas,
        @Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.MetricSpecArgs>> metrics,
        @Nullable Input<Integer> minReplicas,
        Input<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.MetricSpecArgs>> metrics;
        private @Nullable Input<Integer> minReplicas;
        private Input<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef;
        ...
        public Builder setMetrics(@Nullable Input<List<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.MetricSpecArgs>> metrics) {
            this.metrics = metrics;
            return this;
        }

        public Builder setMetrics(@Nullable List<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.MetricSpecArgs> metrics) {
        ...
        public Builder setScaleTargetRef(Input<io.pulumi.kubernetes.autoscaling.v2beta1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef) {
            this.scaleTargetRef = Objects.requireNonNull(scaleTargetRef);
            return this;
        }

        public Builder setScaleTargetRef(io.pulumi.kubernetes.autoscaling.v2beta1.inputs.CrossVersionObjectReferenceArgs scaleTargetRef) {
