...
package io.pulumi.kubernetes.coordination.v1;
...
import io.pulumi.kubernetes.coordination.v1.inputs.*;
...
public class Lease extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.coordination.v1.outputs.LeaseSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.coordination.v1.outputs.LeaseSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.coordination.v1.outputs.LeaseSpec> getSpec() {
        return this.spec;
    }
