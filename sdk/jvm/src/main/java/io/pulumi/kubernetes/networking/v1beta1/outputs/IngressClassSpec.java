...
public final class IngressClassSpec {
    ...
    private final @Nullable io.pulumi.kubernetes.networking.v1beta1.outputs.IngressClassParametersReference parameters;

    @OutputCustomType.Constructor({"controller","parameters"})
    private IngressClassSpec(
        @Nullable String controller,
        @Nullable io.pulumi.kubernetes.networking.v1beta1.outputs.IngressClassParametersReference parameters) {
    ...
    public Optional<io.pulumi.kubernetes.networking.v1beta1.outputs.IngressClassParametersReference> getParameters() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.networking.v1beta1.outputs.IngressClassParametersReference parameters;
        ...
        public Builder setParameters(@Nullable io.pulumi.kubernetes.networking.v1beta1.outputs.IngressClassParametersReference parameters) {
            this.parameters = parameters;
            return this;
        }
