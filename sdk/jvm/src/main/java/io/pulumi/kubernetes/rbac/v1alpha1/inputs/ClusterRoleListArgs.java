...
public final class ClusterRoleListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs>> items;

    public Input<List<io.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs>> getItems() {
        return this.items;
    }
    ...
    public ClusterRoleListArgs(
        ...
        Input<List<io.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.rbac.v1alpha1.inputs.ClusterRoleArgs> items) {
