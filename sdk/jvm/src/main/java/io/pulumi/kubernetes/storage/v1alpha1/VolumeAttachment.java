...
package io.pulumi.kubernetes.storage.v1alpha1;
...
import io.pulumi.kubernetes.storage.v1alpha1.inputs.*;
...
public class VolumeAttachment extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.storage.v1alpha1.outputs.VolumeAttachmentSpec.class, parameters={})
    private Output<io.pulumi.kubernetes.storage.v1alpha1.outputs.VolumeAttachmentSpec> spec;

    public Output<io.pulumi.kubernetes.storage.v1alpha1.outputs.VolumeAttachmentSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.storage.v1alpha1.outputs.VolumeAttachmentStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.storage.v1alpha1.outputs.VolumeAttachmentStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.storage.v1alpha1.outputs.VolumeAttachmentStatus> getStatus() {
        return this.status;
    }

    public VolumeAttachment(String name, VolumeAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachment", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
