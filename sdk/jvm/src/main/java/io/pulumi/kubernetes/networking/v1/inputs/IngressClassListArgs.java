...
public final class IngressClassListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressClassArgs>> items;

    public Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressClassArgs>> getItems() {
        return this.items;
    }
    ...
    public IngressClassListArgs(
        ...
        Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressClassArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressClassArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressClassArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.networking.v1.inputs.IngressClassArgs> items) {
