...
public final class ReplicaSetStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetConditionArgs>> getConditions() {
    ...
    public ReplicaSetStatusArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetConditionArgs>> conditions,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetConditionArgs>> conditions;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetConditionArgs> conditions) {
