...
package io.pulumi.kubernetes.coordination.v1beta1.outputs;
...
public final class Lease {
    ...
    private final @Nullable io.pulumi.kubernetes.coordination.v1beta1.outputs.LeaseSpec spec;
    ...
    private Lease(
        ...
        @Nullable io.pulumi.kubernetes.coordination.v1beta1.outputs.LeaseSpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.coordination.v1beta1.outputs.LeaseSpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.coordination.v1beta1.outputs.LeaseSpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.coordination.v1beta1.outputs.LeaseSpec spec) {
            this.spec = spec;
            return this;
        }
