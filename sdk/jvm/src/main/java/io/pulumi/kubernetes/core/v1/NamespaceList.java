...
public class NamespaceList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.core.v1.outputs.Namespace.class})
    private Output<List<io.pulumi.kubernetes.core.v1.outputs.Namespace>> items;

    public Output<List<io.pulumi.kubernetes.core.v1.outputs.Namespace>> getItems() {
        return this.items;
    }
