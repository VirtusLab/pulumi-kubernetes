...
public final class CertificateSigningRequestArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestSpecArgs> spec;

    public Input<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestSpecArgs> getSpec() {
    ...
    public CertificateSigningRequestArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestSpecArgs spec) {
