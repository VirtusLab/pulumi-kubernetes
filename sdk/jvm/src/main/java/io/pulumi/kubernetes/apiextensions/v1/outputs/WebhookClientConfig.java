...
public final class WebhookClientConfig {
    ...
    private final @Nullable io.pulumi.kubernetes.apiextensions.v1.outputs.ServiceReference service;
    private final @Nullable String url;

    @OutputCustomType.Constructor({"caBundle","service","url"})
    private WebhookClientConfig(
        @Nullable String caBundle,
        @Nullable io.pulumi.kubernetes.apiextensions.v1.outputs.ServiceReference service,
        @Nullable String url) {
    ...
    public Optional<io.pulumi.kubernetes.apiextensions.v1.outputs.ServiceReference> getService() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.apiextensions.v1.outputs.ServiceReference service;
        ...
        public Builder setService(@Nullable io.pulumi.kubernetes.apiextensions.v1.outputs.ServiceReference service) {
            this.service = service;
            return this;
        }
