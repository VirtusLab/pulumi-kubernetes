...
public final class Job {
    ...
    private final @Nullable io.pulumi.kubernetes.batch.v1.outputs.JobStatus status;
    ...
    private Job(
        ...
        @Nullable io.pulumi.kubernetes.batch.v1.outputs.JobStatus status) {
    ...
    public Optional<io.pulumi.kubernetes.batch.v1.outputs.JobStatus> getStatus() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.batch.v1.outputs.JobStatus status;
        ...
        public Builder setStatus(@Nullable io.pulumi.kubernetes.batch.v1.outputs.JobStatus status) {
            this.status = status;
            return this;
        }
