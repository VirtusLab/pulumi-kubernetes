...
public final class LeaseListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.coordination.v1.inputs.LeaseArgs>> items;

    public Input<List<io.pulumi.kubernetes.coordination.v1.inputs.LeaseArgs>> getItems() {
        return this.items;
    }
    ...
    public LeaseListArgs(
        ...
        Input<List<io.pulumi.kubernetes.coordination.v1.inputs.LeaseArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.coordination.v1.inputs.LeaseArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.coordination.v1.inputs.LeaseArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.coordination.v1.inputs.LeaseArgs> items) {
