...
package io.pulumi.kubernetes.batch.v1beta1;
...
import io.pulumi.kubernetes.batch.v1beta1.inputs.*;
...
public class CronJob extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.batch.v1beta1.outputs.CronJobSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.batch.v1beta1.outputs.CronJobSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.batch.v1beta1.outputs.CronJobSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.batch.v1beta1.outputs.CronJobStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.batch.v1beta1.outputs.CronJobStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.batch.v1beta1.outputs.CronJobStatus> getStatus() {
        return this.status;
    }

    public CronJob(String name, @Nullable CronJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1beta1:CronJob", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
