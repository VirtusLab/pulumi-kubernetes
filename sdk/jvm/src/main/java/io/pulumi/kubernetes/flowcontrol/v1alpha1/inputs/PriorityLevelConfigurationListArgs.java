...
public final class PriorityLevelConfigurationListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs>> items;

    public Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs>> getItems() {
        return this.items;
    }
    ...
    public PriorityLevelConfigurationListArgs(
        ...
        Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.PriorityLevelConfigurationArgs> items) {
