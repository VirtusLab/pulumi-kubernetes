...
public class ReplicaSetList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSet.class})
    private Output<List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSet>> items;

    public Output<List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSet>> getItems() {
        return this.items;
    }
