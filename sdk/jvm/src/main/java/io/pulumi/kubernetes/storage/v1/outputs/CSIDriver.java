...
public final class CSIDriver {
    ...
    private final io.pulumi.kubernetes.storage.v1.outputs.CSIDriverSpec spec;
    ...
    private CSIDriver(
        ...
        io.pulumi.kubernetes.storage.v1.outputs.CSIDriverSpec spec) {
    ...
    public io.pulumi.kubernetes.storage.v1.outputs.CSIDriverSpec getSpec() {
        return this.spec;
    }
    ...
    public static final class Builder {
        ...
        private io.pulumi.kubernetes.storage.v1.outputs.CSIDriverSpec spec;
        ...
        public Builder setSpec(io.pulumi.kubernetes.storage.v1.outputs.CSIDriverSpec spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }
