...
public final class EndpointSlice {
    ...
    private final List<io.pulumi.kubernetes.discovery.v1beta1.outputs.Endpoint> endpoints;
    private final @Nullable String kind;
    private final @Nullable io.pulumi.kubernetes.meta.v1.outputs.ObjectMeta metadata;
    private final @Nullable List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointPort> ports;

    @OutputCustomType.Constructor({"addressType","apiVersion","endpoints","kind","metadata","ports"})
    private EndpointSlice(
        String addressType,
        @Nullable String apiVersion,
        List<io.pulumi.kubernetes.discovery.v1beta1.outputs.Endpoint> endpoints,
        @Nullable String kind,
        @Nullable io.pulumi.kubernetes.meta.v1.outputs.ObjectMeta metadata,
        @Nullable List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointPort> ports) {
    ...
    public List<io.pulumi.kubernetes.discovery.v1beta1.outputs.Endpoint> getEndpoints() {
    ...
    public List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointPort> getPorts() {
    ...
    public static final class Builder {
        ...
        private List<io.pulumi.kubernetes.discovery.v1beta1.outputs.Endpoint> endpoints;
        private @Nullable String kind;
        private @Nullable io.pulumi.kubernetes.meta.v1.outputs.ObjectMeta metadata;
        private @Nullable List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointPort> ports;
        ...
        public Builder setEndpoints(List<io.pulumi.kubernetes.discovery.v1beta1.outputs.Endpoint> endpoints) {
            this.endpoints = Objects.requireNonNull(endpoints);
            return this;
        }
        ...
        public Builder setPorts(@Nullable List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointPort> ports) {
            this.ports = ports;
            return this;
        }
