...
public final class IngressListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressArgs>> items;

    public Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressArgs>> getItems() {
        return this.items;
    }
    ...
    public IngressListArgs(
        ...
        Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.networking.v1.inputs.IngressArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.networking.v1.inputs.IngressArgs> items) {
