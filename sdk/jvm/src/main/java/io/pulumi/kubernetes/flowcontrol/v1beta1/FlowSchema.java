...
public class FlowSchema extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.FlowSchemaStatus> getStatus() {
        return this.status;
    }
