...
public final class CertificateSigningRequestListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.certificates.v1.inputs.CertificateSigningRequestArgs>> items;

    public Input<List<io.pulumi.kubernetes.certificates.v1.inputs.CertificateSigningRequestArgs>> getItems() {
        return this.items;
    }
    ...
    public CertificateSigningRequestListArgs(
        ...
        Input<List<io.pulumi.kubernetes.certificates.v1.inputs.CertificateSigningRequestArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.certificates.v1.inputs.CertificateSigningRequestArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.certificates.v1.inputs.CertificateSigningRequestArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.certificates.v1.inputs.CertificateSigningRequestArgs> items) {
