...
public final class ResourceQuotaArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ResourceQuotaSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.ResourceQuotaSpecArgs> getSpec() {
    ...
    public ResourceQuotaArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ResourceQuotaSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ResourceQuotaSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ResourceQuotaSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.ResourceQuotaSpecArgs spec) {
