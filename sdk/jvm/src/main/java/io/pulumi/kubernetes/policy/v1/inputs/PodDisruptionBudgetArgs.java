...
public final class PodDisruptionBudgetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecArgs> spec;

    public Input<io.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecArgs> getSpec() {
    ...
    public PodDisruptionBudgetArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.policy.v1.inputs.PodDisruptionBudgetSpecArgs spec) {
