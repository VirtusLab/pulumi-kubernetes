...
public final class StatefulSetSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetUpdateStrategyArgs> updateStrategy;

    public Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetUpdateStrategyArgs> getUpdateStrategy() {
    ...
    public StatefulSetSpecArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetUpdateStrategyArgs> updateStrategy,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetUpdateStrategyArgs> updateStrategy;
        ...
        public Builder setUpdateStrategy(@Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetUpdateStrategyArgs> updateStrategy) {
            this.updateStrategy = updateStrategy;
            return this;
        }

        public Builder setUpdateStrategy(@Nullable io.pulumi.kubernetes.apps.v1.inputs.StatefulSetUpdateStrategyArgs updateStrategy) {
