...
public final class SecurityContextArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.CapabilitiesArgs> capabilities;

    public Input<io.pulumi.kubernetes.core.v1.inputs.CapabilitiesArgs> getCapabilities() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SeccompProfileArgs> seccompProfile;

    public Input<io.pulumi.kubernetes.core.v1.inputs.SeccompProfileArgs> getSeccompProfile() {
        return this.seccompProfile == null ? Input.empty() : this.seccompProfile;
    }

    @InputImport(name="windowsOptions")
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.WindowsSecurityContextOptionsArgs> windowsOptions;

    public Input<io.pulumi.kubernetes.core.v1.inputs.WindowsSecurityContextOptionsArgs> getWindowsOptions() {
    ...
    public SecurityContextArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.CapabilitiesArgs> capabilities,
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SeccompProfileArgs> seccompProfile,
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.WindowsSecurityContextOptionsArgs> windowsOptions) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.CapabilitiesArgs> capabilities;
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SeccompProfileArgs> seccompProfile;
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.WindowsSecurityContextOptionsArgs> windowsOptions;
        ...
        public Builder setCapabilities(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.CapabilitiesArgs> capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        public Builder setCapabilities(@Nullable io.pulumi.kubernetes.core.v1.inputs.CapabilitiesArgs capabilities) {
        ...
        public Builder setSeccompProfile(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SeccompProfileArgs> seccompProfile) {
            this.seccompProfile = seccompProfile;
            return this;
        }

        public Builder setSeccompProfile(@Nullable io.pulumi.kubernetes.core.v1.inputs.SeccompProfileArgs seccompProfile) {
            this.seccompProfile = Input.ofNullable(seccompProfile);
            return this;
        }

        public Builder setWindowsOptions(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.WindowsSecurityContextOptionsArgs> windowsOptions) {
            this.windowsOptions = windowsOptions;
            return this;
        }

        public Builder setWindowsOptions(@Nullable io.pulumi.kubernetes.core.v1.inputs.WindowsSecurityContextOptionsArgs windowsOptions) {
