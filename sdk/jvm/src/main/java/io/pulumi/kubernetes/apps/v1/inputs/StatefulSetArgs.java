...
public final class StatefulSetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetSpecArgs> spec;

    public Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetSpecArgs> getSpec() {
    ...
    public StatefulSetArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.apps.v1.inputs.StatefulSetSpecArgs spec) {
