...
public final class CSINodeDriver {
    private final @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeNodeResources allocatable;
    ...
    private CSINodeDriver(
        @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeNodeResources allocatable,
        String name,
        String nodeID,
    ...
    public Optional<io.pulumi.kubernetes.storage.v1.outputs.VolumeNodeResources> getAllocatable() {
    ...
    public static final class Builder {
        private @Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeNodeResources allocatable;
        private String name;
        ...
        public Builder setAllocatable(@Nullable io.pulumi.kubernetes.storage.v1.outputs.VolumeNodeResources allocatable) {
            this.allocatable = allocatable;
            return this;
        }
