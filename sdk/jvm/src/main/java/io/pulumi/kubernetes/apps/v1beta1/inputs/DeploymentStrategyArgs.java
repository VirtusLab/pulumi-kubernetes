...
public final class DeploymentStrategyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollingUpdateDeploymentArgs> rollingUpdate;

    public Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollingUpdateDeploymentArgs> getRollingUpdate() {
    ...
    public DeploymentStrategyArgs(
        @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollingUpdateDeploymentArgs> rollingUpdate,
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollingUpdateDeploymentArgs> rollingUpdate;
        ...
        public Builder setRollingUpdate(@Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollingUpdateDeploymentArgs> rollingUpdate) {
            this.rollingUpdate = rollingUpdate;
            return this;
        }

        public Builder setRollingUpdate(@Nullable io.pulumi.kubernetes.apps.v1beta1.inputs.RollingUpdateDeploymentArgs rollingUpdate) {
