...
public final class ServiceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ServiceSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.ServiceSpecArgs> getSpec() {
    ...
    public ServiceArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ServiceSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ServiceSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ServiceSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.ServiceSpecArgs spec) {
