...
public final class APIServiceSpec {
    ...
    private final @Nullable io.pulumi.kubernetes.apiregistration.v1.outputs.ServiceReference service;
    ...
    private APIServiceSpec(
        ...
        @Nullable io.pulumi.kubernetes.apiregistration.v1.outputs.ServiceReference service,
    ...
    public Optional<io.pulumi.kubernetes.apiregistration.v1.outputs.ServiceReference> getService() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.apiregistration.v1.outputs.ServiceReference service;
        ...
        public Builder setService(@Nullable io.pulumi.kubernetes.apiregistration.v1.outputs.ServiceReference service) {
            this.service = service;
            return this;
        }
