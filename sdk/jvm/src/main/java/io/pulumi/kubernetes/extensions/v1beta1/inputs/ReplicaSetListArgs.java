...
public final class ReplicaSetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs>> items;

    public Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs>> getItems() {
        return this.items;
    }
    ...
    public ReplicaSetListArgs(
        ...
        Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetArgs> items) {
