...
public final class ControllerRevisionListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.apps.v1.inputs.ControllerRevisionArgs>> items;

    public Input<List<io.pulumi.kubernetes.apps.v1.inputs.ControllerRevisionArgs>> getItems() {
        return this.items;
    }
    ...
    public ControllerRevisionListArgs(
        ...
        Input<List<io.pulumi.kubernetes.apps.v1.inputs.ControllerRevisionArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.apps.v1.inputs.ControllerRevisionArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.apps.v1.inputs.ControllerRevisionArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.apps.v1.inputs.ControllerRevisionArgs> items) {
