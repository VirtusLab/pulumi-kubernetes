...
public final class MutatingWebhookConfigurationListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs>> items;

    public Input<List<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs>> getItems() {
        return this.items;
    }
    ...
    public MutatingWebhookConfigurationListArgs(
        ...
        Input<List<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.admissionregistration.v1beta1.inputs.MutatingWebhookConfigurationArgs> items) {
