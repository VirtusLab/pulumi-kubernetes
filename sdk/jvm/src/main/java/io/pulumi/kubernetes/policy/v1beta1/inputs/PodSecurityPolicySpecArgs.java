...
public final class PodSecurityPolicySpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverArgs>> allowedCSIDrivers;

    public Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverArgs>> getAllowedCSIDrivers() {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumeArgs>> allowedFlexVolumes;

    public Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumeArgs>> getAllowedFlexVolumes() {
        return this.allowedFlexVolumes == null ? Input.empty() : this.allowedFlexVolumes;
    }

    @InputImport(name="allowedHostPaths")
    private final @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathArgs>> allowedHostPaths;

    public Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathArgs>> getAllowedHostPaths() {
    ...
    private final Input<io.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsArgs> fsGroup;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsArgs> getFsGroup() {
        return this.fsGroup;
    }
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangeArgs>> hostPorts;

    public Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangeArgs>> getHostPorts() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsArgs> runAsGroup;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsArgs> getRunAsGroup() {
        return this.runAsGroup == null ? Input.empty() : this.runAsGroup;
    }

    @InputImport(name="runAsUser", required=true)
    private final Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsArgs> runAsUser;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsArgs> getRunAsUser() {
        return this.runAsUser;
    }

    @InputImport(name="runtimeClass")
    private final @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsArgs> runtimeClass;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsArgs> getRuntimeClass() {
        return this.runtimeClass == null ? Input.empty() : this.runtimeClass;
    }

    @InputImport(name="seLinux", required=true)
    private final Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsArgs> seLinux;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsArgs> getSeLinux() {
        return this.seLinux;
    }

    @InputImport(name="supplementalGroups", required=true)
    private final Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsArgs> supplementalGroups;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsArgs> getSupplementalGroups() {
    ...
    public PodSecurityPolicySpecArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverArgs>> allowedCSIDrivers,
        @Nullable Input<List<String>> allowedCapabilities,
        @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumeArgs>> allowedFlexVolumes,
        @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathArgs>> allowedHostPaths,
        ...
        Input<io.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsArgs> fsGroup,
        @Nullable Input<Boolean> hostIPC,
        @Nullable Input<Boolean> hostNetwork,
        @Nullable Input<Boolean> hostPID,
        @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangeArgs>> hostPorts,
        ...
        @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsArgs> runAsGroup,
        Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsArgs> runAsUser,
        @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsArgs> runtimeClass,
        Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsArgs> seLinux,
        Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsArgs> supplementalGroups,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverArgs>> allowedCSIDrivers;
        private @Nullable Input<List<String>> allowedCapabilities;
        private @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumeArgs>> allowedFlexVolumes;
        private @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathArgs>> allowedHostPaths;
        ...
        private Input<io.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsArgs> fsGroup;
        private @Nullable Input<Boolean> hostIPC;
        private @Nullable Input<Boolean> hostNetwork;
        private @Nullable Input<Boolean> hostPID;
        private @Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangeArgs>> hostPorts;
        ...
        private @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsArgs> runAsGroup;
        private Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsArgs> runAsUser;
        private @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsArgs> runtimeClass;
        private Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsArgs> seLinux;
        private Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsArgs> supplementalGroups;
        ...
        public Builder setAllowedCSIDrivers(@Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverArgs>> allowedCSIDrivers) {
            this.allowedCSIDrivers = allowedCSIDrivers;
            return this;
        }

        public Builder setAllowedCSIDrivers(@Nullable List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedCSIDriverArgs> allowedCSIDrivers) {
        ...
        public Builder setAllowedFlexVolumes(@Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumeArgs>> allowedFlexVolumes) {
            this.allowedFlexVolumes = allowedFlexVolumes;
            return this;
        }

        public Builder setAllowedFlexVolumes(@Nullable List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedFlexVolumeArgs> allowedFlexVolumes) {
            this.allowedFlexVolumes = Input.ofNullable(allowedFlexVolumes);
            return this;
        }

        public Builder setAllowedHostPaths(@Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathArgs>> allowedHostPaths) {
            this.allowedHostPaths = allowedHostPaths;
            return this;
        }

        public Builder setAllowedHostPaths(@Nullable List<io.pulumi.kubernetes.policy.v1beta1.inputs.AllowedHostPathArgs> allowedHostPaths) {
        ...
        public Builder setFsGroup(Input<io.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsArgs> fsGroup) {
            this.fsGroup = Objects.requireNonNull(fsGroup);
            return this;
        }

        public Builder setFsGroup(io.pulumi.kubernetes.policy.v1beta1.inputs.FSGroupStrategyOptionsArgs fsGroup) {
        ...
        public Builder setHostPorts(@Nullable Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangeArgs>> hostPorts) {
            this.hostPorts = hostPorts;
            return this;
        }

        public Builder setHostPorts(@Nullable List<io.pulumi.kubernetes.policy.v1beta1.inputs.HostPortRangeArgs> hostPorts) {
        ...
        public Builder setRunAsGroup(@Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsArgs> runAsGroup) {
            this.runAsGroup = runAsGroup;
            return this;
        }

        public Builder setRunAsGroup(@Nullable io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsGroupStrategyOptionsArgs runAsGroup) {
            this.runAsGroup = Input.ofNullable(runAsGroup);
            return this;
        }

        public Builder setRunAsUser(Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsArgs> runAsUser) {
            this.runAsUser = Objects.requireNonNull(runAsUser);
            return this;
        }

        public Builder setRunAsUser(io.pulumi.kubernetes.policy.v1beta1.inputs.RunAsUserStrategyOptionsArgs runAsUser) {
            this.runAsUser = Input.of(Objects.requireNonNull(runAsUser));
            return this;
        }

        public Builder setRuntimeClass(@Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsArgs> runtimeClass) {
            this.runtimeClass = runtimeClass;
            return this;
        }

        public Builder setRuntimeClass(@Nullable io.pulumi.kubernetes.policy.v1beta1.inputs.RuntimeClassStrategyOptionsArgs runtimeClass) {
            this.runtimeClass = Input.ofNullable(runtimeClass);
            return this;
        }

        public Builder setSeLinux(Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsArgs> seLinux) {
            this.seLinux = Objects.requireNonNull(seLinux);
            return this;
        }

        public Builder setSeLinux(io.pulumi.kubernetes.policy.v1beta1.inputs.SELinuxStrategyOptionsArgs seLinux) {
            this.seLinux = Input.of(Objects.requireNonNull(seLinux));
            return this;
        }

        public Builder setSupplementalGroups(Input<io.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsArgs> supplementalGroups) {
            this.supplementalGroups = Objects.requireNonNull(supplementalGroups);
            return this;
        }

        public Builder setSupplementalGroups(io.pulumi.kubernetes.policy.v1beta1.inputs.SupplementalGroupsStrategyOptionsArgs supplementalGroups) {
