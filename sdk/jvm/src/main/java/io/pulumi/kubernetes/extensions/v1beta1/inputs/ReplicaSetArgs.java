...
public final class ReplicaSetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetSpecArgs> spec;

    public Input<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetSpecArgs> getSpec() {
    ...
    public ReplicaSetArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.extensions.v1beta1.inputs.ReplicaSetSpecArgs spec) {
