...
package io.pulumi.kubernetes.autoscaling.v1.inputs;
...
public final class HorizontalPodAutoscalerSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.autoscaling.v1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef;

    public Input<io.pulumi.kubernetes.autoscaling.v1.inputs.CrossVersionObjectReferenceArgs> getScaleTargetRef() {
    ...
    public HorizontalPodAutoscalerSpecArgs(
        ...
        Input<io.pulumi.kubernetes.autoscaling.v1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef,
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.autoscaling.v1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef;
        ...
        public Builder setScaleTargetRef(Input<io.pulumi.kubernetes.autoscaling.v1.inputs.CrossVersionObjectReferenceArgs> scaleTargetRef) {
            this.scaleTargetRef = Objects.requireNonNull(scaleTargetRef);
            return this;
        }

        public Builder setScaleTargetRef(io.pulumi.kubernetes.autoscaling.v1.inputs.CrossVersionObjectReferenceArgs scaleTargetRef) {
