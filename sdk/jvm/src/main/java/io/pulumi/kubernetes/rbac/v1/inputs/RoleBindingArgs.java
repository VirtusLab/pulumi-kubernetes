...
public final class RoleBindingArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.rbac.v1.inputs.RoleRefArgs> roleRef;

    public Input<io.pulumi.kubernetes.rbac.v1.inputs.RoleRefArgs> getRoleRef() {
        return this.roleRef;
    }

    @InputImport(name="subjects")
    private final @Nullable Input<List<io.pulumi.kubernetes.rbac.v1.inputs.SubjectArgs>> subjects;

    public Input<List<io.pulumi.kubernetes.rbac.v1.inputs.SubjectArgs>> getSubjects() {
    ...
    public RoleBindingArgs(
        ...
        Input<io.pulumi.kubernetes.rbac.v1.inputs.RoleRefArgs> roleRef,
        @Nullable Input<List<io.pulumi.kubernetes.rbac.v1.inputs.SubjectArgs>> subjects) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.rbac.v1.inputs.RoleRefArgs> roleRef;
        private @Nullable Input<List<io.pulumi.kubernetes.rbac.v1.inputs.SubjectArgs>> subjects;
        ...
        public Builder setRoleRef(Input<io.pulumi.kubernetes.rbac.v1.inputs.RoleRefArgs> roleRef) {
            this.roleRef = Objects.requireNonNull(roleRef);
            return this;
        }

        public Builder setRoleRef(io.pulumi.kubernetes.rbac.v1.inputs.RoleRefArgs roleRef) {
            this.roleRef = Input.of(Objects.requireNonNull(roleRef));
            return this;
        }

        public Builder setSubjects(@Nullable Input<List<io.pulumi.kubernetes.rbac.v1.inputs.SubjectArgs>> subjects) {
            this.subjects = subjects;
            return this;
        }

        public Builder setSubjects(@Nullable List<io.pulumi.kubernetes.rbac.v1.inputs.SubjectArgs> subjects) {
