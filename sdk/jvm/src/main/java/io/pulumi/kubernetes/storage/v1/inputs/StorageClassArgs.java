...
public final class StorageClassArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TopologySelectorTermArgs>> allowedTopologies;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.TopologySelectorTermArgs>> getAllowedTopologies() {
    ...
    public StorageClassArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TopologySelectorTermArgs>> allowedTopologies,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TopologySelectorTermArgs>> allowedTopologies;
        ...
        public Builder setAllowedTopologies(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TopologySelectorTermArgs>> allowedTopologies) {
            this.allowedTopologies = allowedTopologies;
            return this;
        }

        public Builder setAllowedTopologies(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.TopologySelectorTermArgs> allowedTopologies) {
