...
public class NetworkPolicyList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.networking.v1.outputs.NetworkPolicy.class})
    private Output<List<io.pulumi.kubernetes.networking.v1.outputs.NetworkPolicy>> items;

    public Output<List<io.pulumi.kubernetes.networking.v1.outputs.NetworkPolicy>> getItems() {
        return this.items;
    }
