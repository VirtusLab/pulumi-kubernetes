...
public final class RoleBindingListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleBindingArgs>> items;

    public Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleBindingArgs>> getItems() {
        return this.items;
    }
    ...
    public RoleBindingListArgs(
        ...
        Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleBindingArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleBindingArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleBindingArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleBindingArgs> items) {
