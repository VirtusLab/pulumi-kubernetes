...
public final class MutatingWebhookConfiguration {
    ...
    private final @Nullable List<io.pulumi.kubernetes.admissionregistration.v1.outputs.MutatingWebhook> webhooks;
    ...
    private MutatingWebhookConfiguration(
        ...
        @Nullable List<io.pulumi.kubernetes.admissionregistration.v1.outputs.MutatingWebhook> webhooks) {
    ...
    public List<io.pulumi.kubernetes.admissionregistration.v1.outputs.MutatingWebhook> getWebhooks() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.admissionregistration.v1.outputs.MutatingWebhook> webhooks;
        ...
        public Builder setWebhooks(@Nullable List<io.pulumi.kubernetes.admissionregistration.v1.outputs.MutatingWebhook> webhooks) {
            this.webhooks = webhooks;
            return this;
        }
