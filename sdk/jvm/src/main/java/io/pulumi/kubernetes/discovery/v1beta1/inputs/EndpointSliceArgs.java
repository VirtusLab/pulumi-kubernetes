...
public final class EndpointSliceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointArgs>> endpoints;

    public Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointArgs>> getEndpoints() {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointPortArgs>> ports;

    public Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointPortArgs>> getPorts() {
    ...
    public EndpointSliceArgs(
        ...
        Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointArgs>> endpoints,
        @Nullable Input<String> kind,
        @Nullable Input<io.pulumi.kubernetes.meta.v1.inputs.ObjectMetaArgs> metadata,
        @Nullable Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointPortArgs>> ports) {
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointArgs>> endpoints;
        private @Nullable Input<String> kind;
        private @Nullable Input<io.pulumi.kubernetes.meta.v1.inputs.ObjectMetaArgs> metadata;
        private @Nullable Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointPortArgs>> ports;
        ...
        public Builder setEndpoints(Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointArgs>> endpoints) {
            this.endpoints = Objects.requireNonNull(endpoints);
            return this;
        }

        public Builder setEndpoints(List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointArgs> endpoints) {
        ...
        public Builder setPorts(@Nullable Input<List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointPortArgs>> ports) {
            this.ports = ports;
            return this;
        }

        public Builder setPorts(@Nullable List<io.pulumi.kubernetes.discovery.v1beta1.inputs.EndpointPortArgs> ports) {
