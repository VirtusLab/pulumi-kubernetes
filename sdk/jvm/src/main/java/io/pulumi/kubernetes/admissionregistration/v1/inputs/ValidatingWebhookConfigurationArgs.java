...
public final class ValidatingWebhookConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.ValidatingWebhookArgs>> webhooks;

    public Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.ValidatingWebhookArgs>> getWebhooks() {
    ...
    public ValidatingWebhookConfigurationArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.ValidatingWebhookArgs>> webhooks) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.ValidatingWebhookArgs>> webhooks;
        ...
        public Builder setWebhooks(@Nullable Input<List<io.pulumi.kubernetes.admissionregistration.v1.inputs.ValidatingWebhookArgs>> webhooks) {
            this.webhooks = webhooks;
            return this;
        }

        public Builder setWebhooks(@Nullable List<io.pulumi.kubernetes.admissionregistration.v1.inputs.ValidatingWebhookArgs> webhooks) {
