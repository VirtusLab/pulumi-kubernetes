...
public final class CustomResourceDefinitionVersionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceColumnDefinitionArgs>> additionalPrinterColumns;

    public Input<List<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceColumnDefinitionArgs>> getAdditionalPrinterColumns() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceValidationArgs> schema;

    public Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceValidationArgs> getSchema() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceSubresourcesArgs> subresources;

    public Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceSubresourcesArgs> getSubresources() {
        return this.subresources == null ? Input.empty() : this.subresources;
    }

    public CustomResourceDefinitionVersionArgs(
        @Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceColumnDefinitionArgs>> additionalPrinterColumns,
        @Nullable Input<Boolean> deprecated,
        @Nullable Input<String> deprecationWarning,
        Input<String> name,
        @Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceValidationArgs> schema,
        Input<Boolean> served,
        Input<Boolean> storage,
        @Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceSubresourcesArgs> subresources) {
    ...
    public static final class Builder {
        private @Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceColumnDefinitionArgs>> additionalPrinterColumns;
        private @Nullable Input<Boolean> deprecated;
        private @Nullable Input<String> deprecationWarning;
        private Input<String> name;
        private @Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceValidationArgs> schema;
        private Input<Boolean> served;
        private Input<Boolean> storage;
        private @Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceSubresourcesArgs> subresources;
        ...
        public Builder setAdditionalPrinterColumns(@Nullable Input<List<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceColumnDefinitionArgs>> additionalPrinterColumns) {
            this.additionalPrinterColumns = additionalPrinterColumns;
            return this;
        }

        public Builder setAdditionalPrinterColumns(@Nullable List<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceColumnDefinitionArgs> additionalPrinterColumns) {
        ...
        public Builder setSchema(@Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceValidationArgs> schema) {
            this.schema = schema;
            return this;
        }

        public Builder setSchema(@Nullable io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceValidationArgs schema) {
        ...
        public Builder setSubresources(@Nullable Input<io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceSubresourcesArgs> subresources) {
            this.subresources = subresources;
            return this;
        }

        public Builder setSubresources(@Nullable io.pulumi.kubernetes.apiextensions.v1.inputs.CustomResourceSubresourcesArgs subresources) {
