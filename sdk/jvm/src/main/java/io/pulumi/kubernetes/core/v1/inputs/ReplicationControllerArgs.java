...
public final class ReplicationControllerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerSpecArgs> getSpec() {
    ...
    public ReplicationControllerArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.ReplicationControllerSpecArgs spec) {
