...
public class MutatingWebhookConfigurationList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.MutatingWebhookConfiguration.class})
    private Output<List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.MutatingWebhookConfiguration>> items;

    public Output<List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.MutatingWebhookConfiguration>> getItems() {
        return this.items;
    }
    ...
    public MutatingWebhookConfigurationList(String name, MutatingWebhookConfigurationListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfigurationList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
