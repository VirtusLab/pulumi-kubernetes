...
public final class LimitRangeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecArgs> getSpec() {
    ...
    public LimitRangeArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.LimitRangeSpecArgs spec) {
