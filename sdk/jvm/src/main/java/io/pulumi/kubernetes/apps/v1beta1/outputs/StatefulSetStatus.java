...
public final class StatefulSetStatus {
    ...
    private final @Nullable List<io.pulumi.kubernetes.apps.v1beta1.outputs.StatefulSetCondition> conditions;
    ...
    private StatefulSetStatus(
        ...
        @Nullable List<io.pulumi.kubernetes.apps.v1beta1.outputs.StatefulSetCondition> conditions,
    ...
    public List<io.pulumi.kubernetes.apps.v1beta1.outputs.StatefulSetCondition> getConditions() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.apps.v1beta1.outputs.StatefulSetCondition> conditions;
        ...
        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.apps.v1beta1.outputs.StatefulSetCondition> conditions) {
            this.conditions = conditions;
            return this;
        }
