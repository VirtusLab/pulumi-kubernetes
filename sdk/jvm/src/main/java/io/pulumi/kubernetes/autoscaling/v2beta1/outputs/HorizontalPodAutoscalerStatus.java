...
public final class HorizontalPodAutoscalerStatus {
    private final List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.HorizontalPodAutoscalerCondition> conditions;
    private final @Nullable List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.MetricStatus> currentMetrics;
    ...
    private HorizontalPodAutoscalerStatus(
        List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.HorizontalPodAutoscalerCondition> conditions,
        @Nullable List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.MetricStatus> currentMetrics,
    ...
    public List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.HorizontalPodAutoscalerCondition> getConditions() {
        return this.conditions;
    }
    public List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.MetricStatus> getCurrentMetrics() {
    ...
    public static final class Builder {
        private List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.HorizontalPodAutoscalerCondition> conditions;
        private @Nullable List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.MetricStatus> currentMetrics;
        ...
        public Builder setConditions(List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.HorizontalPodAutoscalerCondition> conditions) {
            this.conditions = Objects.requireNonNull(conditions);
            return this;
        }

        public Builder setCurrentMetrics(@Nullable List<io.pulumi.kubernetes.autoscaling.v2beta1.outputs.MetricStatus> currentMetrics) {
            this.currentMetrics = currentMetrics;
            return this;
        }
