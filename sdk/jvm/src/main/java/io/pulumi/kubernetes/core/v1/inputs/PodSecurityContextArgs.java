...
public final class PodSecurityContextArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.SysctlArgs>> sysctls;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.SysctlArgs>> getSysctls() {
    ...
    public PodSecurityContextArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.SysctlArgs>> sysctls,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.SysctlArgs>> sysctls;
        ...
        public Builder setSysctls(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.SysctlArgs>> sysctls) {
            this.sysctls = sysctls;
            return this;
        }

        public Builder setSysctls(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.SysctlArgs> sysctls) {
