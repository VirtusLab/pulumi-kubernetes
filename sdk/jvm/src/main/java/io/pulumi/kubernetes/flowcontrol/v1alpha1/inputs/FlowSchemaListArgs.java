...
public final class FlowSchemaListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaArgs>> items;

    public Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaArgs>> getItems() {
        return this.items;
    }
    ...
    public FlowSchemaListArgs(
        ...
        Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaArgs> items) {
