...
public final class IngressRuleArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.networking.v1beta1.inputs.HTTPIngressRuleValueArgs> http;

    public Input<io.pulumi.kubernetes.networking.v1beta1.inputs.HTTPIngressRuleValueArgs> getHttp() {
        return this.http == null ? Input.empty() : this.http;
    }

    public IngressRuleArgs(
        @Nullable Input<String> host,
        @Nullable Input<io.pulumi.kubernetes.networking.v1beta1.inputs.HTTPIngressRuleValueArgs> http) {
        this.host = host;
        this.http = http;
    }
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.networking.v1beta1.inputs.HTTPIngressRuleValueArgs> http;
        ...
        public Builder setHttp(@Nullable Input<io.pulumi.kubernetes.networking.v1beta1.inputs.HTTPIngressRuleValueArgs> http) {
            this.http = http;
            return this;
        }

        public Builder setHttp(@Nullable io.pulumi.kubernetes.networking.v1beta1.inputs.HTTPIngressRuleValueArgs http) {
