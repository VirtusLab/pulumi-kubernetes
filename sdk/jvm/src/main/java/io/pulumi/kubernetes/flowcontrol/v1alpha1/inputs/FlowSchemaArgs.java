...
public final class FlowSchemaArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecArgs> spec;

    public Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecArgs> getSpec() {
    ...
    public FlowSchemaArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.flowcontrol.v1alpha1.inputs.FlowSchemaSpecArgs spec) {
