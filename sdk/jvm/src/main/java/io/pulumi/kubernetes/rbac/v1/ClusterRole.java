...
public class ClusterRole extends io.pulumi.kubernetes.KubernetesResource {
    @OutputExport(name="aggregationRule", type=io.pulumi.kubernetes.rbac.v1.outputs.AggregationRule.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.rbac.v1.outputs.AggregationRule> aggregationRule;

    public Output</* @Nullable */ io.pulumi.kubernetes.rbac.v1.outputs.AggregationRule> getAggregationRule() {
