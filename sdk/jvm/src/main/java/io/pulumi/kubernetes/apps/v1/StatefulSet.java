...
public class StatefulSet extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.apps.v1.outputs.StatefulSetSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.apps.v1.outputs.StatefulSetSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.apps.v1.outputs.StatefulSetSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.apps.v1.outputs.StatefulSetStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.apps.v1.outputs.StatefulSetStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.apps.v1.outputs.StatefulSetStatus> getStatus() {
        return this.status;
    }
