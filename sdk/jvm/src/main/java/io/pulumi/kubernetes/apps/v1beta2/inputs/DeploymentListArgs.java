...
public final class DeploymentListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentArgs>> items;

    public Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentArgs>> getItems() {
        return this.items;
    }
    ...
    public DeploymentListArgs(
        ...
        Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.apps.v1beta2.inputs.DeploymentArgs> items) {
