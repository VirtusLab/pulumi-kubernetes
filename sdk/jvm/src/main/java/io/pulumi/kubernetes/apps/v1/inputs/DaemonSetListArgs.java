...
public final class DaemonSetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetArgs>> items;

    public Input<List<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetArgs>> getItems() {
        return this.items;
    }
    ...
    public DaemonSetListArgs(
        ...
        Input<List<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetArgs> items) {
