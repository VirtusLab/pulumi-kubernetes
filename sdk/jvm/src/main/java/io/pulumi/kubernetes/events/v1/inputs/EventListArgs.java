...
public final class EventListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.events.v1.inputs.EventArgs>> items;

    public Input<List<io.pulumi.kubernetes.events.v1.inputs.EventArgs>> getItems() {
        return this.items;
    }
    ...
    public EventListArgs(
        ...
        Input<List<io.pulumi.kubernetes.events.v1.inputs.EventArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.events.v1.inputs.EventArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.events.v1.inputs.EventArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.events.v1.inputs.EventArgs> items) {
