...
public final class IngressClassArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassSpecArgs> spec;

    public Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassSpecArgs> getSpec() {
    ...
    public IngressClassArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressClassSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.networking.v1.inputs.IngressClassSpecArgs spec) {
