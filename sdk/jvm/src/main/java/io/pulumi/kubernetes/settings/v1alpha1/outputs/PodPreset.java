...
public final class PodPreset {
    ...
    private final @Nullable io.pulumi.kubernetes.settings.v1alpha1.outputs.PodPresetSpec spec;
    ...
    private PodPreset(
        ...
        @Nullable io.pulumi.kubernetes.settings.v1alpha1.outputs.PodPresetSpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.settings.v1alpha1.outputs.PodPresetSpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.settings.v1alpha1.outputs.PodPresetSpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.settings.v1alpha1.outputs.PodPresetSpec spec) {
            this.spec = spec;
            return this;
        }
