...
public class CertificateSigningRequestList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.certificates.v1beta1.outputs.CertificateSigningRequest.class})
    private Output<List<io.pulumi.kubernetes.certificates.v1beta1.outputs.CertificateSigningRequest>> items;

    public Output<List<io.pulumi.kubernetes.certificates.v1beta1.outputs.CertificateSigningRequest>> getItems() {
        return this.items;
    }
