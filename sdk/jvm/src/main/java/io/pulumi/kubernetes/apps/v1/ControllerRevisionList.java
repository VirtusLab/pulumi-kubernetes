...
public class ControllerRevisionList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1.outputs.ControllerRevision.class})
    private Output<List<io.pulumi.kubernetes.apps.v1.outputs.ControllerRevision>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1.outputs.ControllerRevision>> getItems() {
        return this.items;
    }
    ...
    public ControllerRevisionList(String name, ControllerRevisionListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ControllerRevisionList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
