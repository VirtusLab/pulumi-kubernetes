...
public class ResourceQuota extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.core.v1.outputs.ResourceQuotaSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.ResourceQuotaSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.ResourceQuotaSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.core.v1.outputs.ResourceQuotaStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.ResourceQuotaStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.core.v1.outputs.ResourceQuotaStatus> getStatus() {
        return this.status;
    }
