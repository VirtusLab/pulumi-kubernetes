...
public final class PodDisruptionBudgetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.PodDisruptionBudgetArgs>> items;

    public Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.PodDisruptionBudgetArgs>> getItems() {
        return this.items;
    }
    ...
    public PodDisruptionBudgetListArgs(
        ...
        Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.PodDisruptionBudgetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.PodDisruptionBudgetArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.policy.v1beta1.inputs.PodDisruptionBudgetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.policy.v1beta1.inputs.PodDisruptionBudgetArgs> items) {
