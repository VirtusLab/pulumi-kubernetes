...
public final class StorageOSPersistentVolumeSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ObjectReferenceArgs> secretRef;

    public Input<io.pulumi.kubernetes.core.v1.inputs.ObjectReferenceArgs> getSecretRef() {
    ...
    public StorageOSPersistentVolumeSourceArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ObjectReferenceArgs> secretRef,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ObjectReferenceArgs> secretRef;
        ...
        public Builder setSecretRef(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ObjectReferenceArgs> secretRef) {
            this.secretRef = secretRef;
            return this;
        }

        public Builder setSecretRef(@Nullable io.pulumi.kubernetes.core.v1.inputs.ObjectReferenceArgs secretRef) {
