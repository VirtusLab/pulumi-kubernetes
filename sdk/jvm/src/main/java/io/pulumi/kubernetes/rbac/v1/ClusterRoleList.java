...
public class ClusterRoleList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.rbac.v1.outputs.ClusterRole.class})
    private Output<List<io.pulumi.kubernetes.rbac.v1.outputs.ClusterRole>> items;

    public Output<List<io.pulumi.kubernetes.rbac.v1.outputs.ClusterRole>> getItems() {
        return this.items;
    }
    ...
    public ClusterRoleList(String name, ClusterRoleListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
