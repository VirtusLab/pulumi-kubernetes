...
public class DeploymentList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1beta2.outputs.Deployment.class})
    private Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.Deployment>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1beta2.outputs.Deployment>> getItems() {
        return this.items;
    }
    ...
    public DeploymentList(String name, DeploymentListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:DeploymentList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
