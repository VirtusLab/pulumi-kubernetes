...
public final class ContainerStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> lastState;

    public Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> getLastState() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> state;

    public Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> getState() {
    ...
    public ContainerStatusArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> lastState,
        Input<String> name,
        Input<Boolean> ready,
        Input<Integer> restartCount,
        @Nullable Input<Boolean> started,
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> state) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> lastState;
        private Input<String> name;
        private Input<Boolean> ready;
        private Input<Integer> restartCount;
        private @Nullable Input<Boolean> started;
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> state;
        ...
        public Builder setLastState(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> lastState) {
            this.lastState = lastState;
            return this;
        }

        public Builder setLastState(@Nullable io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs lastState) {
        ...
        public Builder setState(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs> state) {
            this.state = state;
            return this;
        }

        public Builder setState(@Nullable io.pulumi.kubernetes.core.v1.inputs.ContainerStateArgs state) {
