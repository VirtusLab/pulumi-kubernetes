...
public final class PersistentVolumeClaimListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimArgs>> items;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimArgs>> getItems() {
        return this.items;
    }
    ...
    public PersistentVolumeClaimListArgs(
        ...
        Input<List<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.core.v1.inputs.PersistentVolumeClaimArgs> items) {
