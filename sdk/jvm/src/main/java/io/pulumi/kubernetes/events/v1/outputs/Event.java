...
public final class Event {
    ...
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.EventSource deprecatedSource;
    ...
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.ObjectReference regarding;
    ...
    private final @Nullable io.pulumi.kubernetes.events.v1.outputs.EventSeries series;
    ...
    private Event(
        ...
        @Nullable io.pulumi.kubernetes.core.v1.outputs.EventSource deprecatedSource,
        String eventTime,
        @Nullable String kind,
        @Nullable io.pulumi.kubernetes.meta.v1.outputs.ObjectMeta metadata,
        @Nullable String note,
        @Nullable String reason,
        @Nullable io.pulumi.kubernetes.core.v1.outputs.ObjectReference regarding,
        ...
        @Nullable io.pulumi.kubernetes.events.v1.outputs.EventSeries series,
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.EventSource> getDeprecatedSource() {
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.ObjectReference> getRegarding() {
    ...
    public Optional<io.pulumi.kubernetes.events.v1.outputs.EventSeries> getSeries() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.EventSource deprecatedSource;
        private String eventTime;
        private @Nullable String kind;
        private @Nullable io.pulumi.kubernetes.meta.v1.outputs.ObjectMeta metadata;
        private @Nullable String note;
        private @Nullable String reason;
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.ObjectReference regarding;
        ...
        private @Nullable io.pulumi.kubernetes.events.v1.outputs.EventSeries series;
        ...
        public Builder setDeprecatedSource(@Nullable io.pulumi.kubernetes.core.v1.outputs.EventSource deprecatedSource) {
            this.deprecatedSource = deprecatedSource;
            return this;
        }
        ...
        public Builder setRegarding(@Nullable io.pulumi.kubernetes.core.v1.outputs.ObjectReference regarding) {
            this.regarding = regarding;
            return this;
        }
        ...
        public Builder setSeries(@Nullable io.pulumi.kubernetes.events.v1.outputs.EventSeries series) {
            this.series = series;
            return this;
        }
