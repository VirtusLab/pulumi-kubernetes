...
public final class ServiceSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ServicePortArgs>> ports;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.ServicePortArgs>> getPorts() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SessionAffinityConfigArgs> sessionAffinityConfig;

    public Input<io.pulumi.kubernetes.core.v1.inputs.SessionAffinityConfigArgs> getSessionAffinityConfig() {
    ...
    private final @Nullable Input<Either<String,io.pulumi.kubernetes.core.v1.enums.ServiceSpecType>> type;

    public Input<Either<String,io.pulumi.kubernetes.core.v1.enums.ServiceSpecType>> getType() {
    ...
    public ServiceSpecArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ServicePortArgs>> ports,
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SessionAffinityConfigArgs> sessionAffinityConfig,
        @Nullable Input<List<String>> topologyKeys,
        @Nullable Input<Either<String,io.pulumi.kubernetes.core.v1.enums.ServiceSpecType>> type) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ServicePortArgs>> ports;
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SessionAffinityConfigArgs> sessionAffinityConfig;
        private @Nullable Input<List<String>> topologyKeys;
        private @Nullable Input<Either<String,io.pulumi.kubernetes.core.v1.enums.ServiceSpecType>> type;
        ...
        public Builder setPorts(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.ServicePortArgs>> ports) {
            this.ports = ports;
            return this;
        }

        public Builder setPorts(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.ServicePortArgs> ports) {
        ...
        public Builder setSessionAffinityConfig(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.SessionAffinityConfigArgs> sessionAffinityConfig) {
            this.sessionAffinityConfig = sessionAffinityConfig;
            return this;
        }

        public Builder setSessionAffinityConfig(@Nullable io.pulumi.kubernetes.core.v1.inputs.SessionAffinityConfigArgs sessionAffinityConfig) {
        ...
        public Builder setType(@Nullable Input<Either<String,io.pulumi.kubernetes.core.v1.enums.ServiceSpecType>> type) {
            this.type = type;
            return this;
        }

        public Builder setType(@Nullable Either<String,io.pulumi.kubernetes.core.v1.enums.ServiceSpecType> type) {
