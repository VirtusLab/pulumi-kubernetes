...
public final class StatefulSetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetArgs>> items;

    public Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetArgs>> getItems() {
        return this.items;
    }
    ...
    public StatefulSetListArgs(
        ...
        Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.apps.v1beta2.inputs.StatefulSetArgs> items) {
