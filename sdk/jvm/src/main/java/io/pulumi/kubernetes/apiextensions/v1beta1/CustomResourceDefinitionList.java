...
public class CustomResourceDefinitionList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apiextensions.v1beta1.outputs.CustomResourceDefinition.class})
    private Output<List<io.pulumi.kubernetes.apiextensions.v1beta1.outputs.CustomResourceDefinition>> items;

    public Output<List<io.pulumi.kubernetes.apiextensions.v1beta1.outputs.CustomResourceDefinition>> getItems() {
        return this.items;
    }
