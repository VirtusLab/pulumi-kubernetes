...
public final class RoleListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleArgs>> items;

    public Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleArgs>> getItems() {
        return this.items;
    }
    ...
    public RoleListArgs(
        ...
        Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.rbac.v1beta1.inputs.RoleArgs> items) {
