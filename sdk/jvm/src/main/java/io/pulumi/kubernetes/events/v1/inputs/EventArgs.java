...
public final class EventArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.events.v1.inputs.EventSeriesArgs> series;

    public Input<io.pulumi.kubernetes.events.v1.inputs.EventSeriesArgs> getSeries() {
    ...
    public EventArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.events.v1.inputs.EventSeriesArgs> series,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.events.v1.inputs.EventSeriesArgs> series;
        ...
        public Builder setSeries(@Nullable Input<io.pulumi.kubernetes.events.v1.inputs.EventSeriesArgs> series) {
            this.series = series;
            return this;
        }

        public Builder setSeries(@Nullable io.pulumi.kubernetes.events.v1.inputs.EventSeriesArgs series) {
