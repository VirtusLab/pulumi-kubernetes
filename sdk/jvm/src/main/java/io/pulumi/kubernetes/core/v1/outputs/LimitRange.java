...
public final class LimitRange {
    ...
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec spec;
    ...
    private LimitRange(
        ...
        @Nullable io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec spec) {
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec> getSpec() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec spec;
        ...
        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.outputs.LimitRangeSpec spec) {
            this.spec = spec;
            return this;
        }
