...
public final class SubjectAccessReviewSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.NonResourceAttributesArgs> nonResourceAttributes;

    public Input<io.pulumi.kubernetes.authorization.v1.inputs.NonResourceAttributesArgs> getNonResourceAttributes() {
        return this.nonResourceAttributes == null ? Input.empty() : this.nonResourceAttributes;
    }

    @InputImport(name="resourceAttributes")
    private final @Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.ResourceAttributesArgs> resourceAttributes;

    public Input<io.pulumi.kubernetes.authorization.v1.inputs.ResourceAttributesArgs> getResourceAttributes() {
    ...
    public SubjectAccessReviewSpecArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.NonResourceAttributesArgs> nonResourceAttributes,
        @Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.ResourceAttributesArgs> resourceAttributes,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.NonResourceAttributesArgs> nonResourceAttributes;
        private @Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.ResourceAttributesArgs> resourceAttributes;
        ...
        public Builder setNonResourceAttributes(@Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.NonResourceAttributesArgs> nonResourceAttributes) {
            this.nonResourceAttributes = nonResourceAttributes;
            return this;
        }

        public Builder setNonResourceAttributes(@Nullable io.pulumi.kubernetes.authorization.v1.inputs.NonResourceAttributesArgs nonResourceAttributes) {
            this.nonResourceAttributes = Input.ofNullable(nonResourceAttributes);
            return this;
        }

        public Builder setResourceAttributes(@Nullable Input<io.pulumi.kubernetes.authorization.v1.inputs.ResourceAttributesArgs> resourceAttributes) {
            this.resourceAttributes = resourceAttributes;
            return this;
        }

        public Builder setResourceAttributes(@Nullable io.pulumi.kubernetes.authorization.v1.inputs.ResourceAttributesArgs resourceAttributes) {
