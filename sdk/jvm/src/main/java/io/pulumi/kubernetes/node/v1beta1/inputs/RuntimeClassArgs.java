...
package io.pulumi.kubernetes.node.v1beta1.inputs;
...
public final class RuntimeClassArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.OverheadArgs> overhead;

    public Input<io.pulumi.kubernetes.node.v1beta1.inputs.OverheadArgs> getOverhead() {
        return this.overhead == null ? Input.empty() : this.overhead;
    }

    @InputImport(name="scheduling")
    private final @Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.SchedulingArgs> scheduling;

    public Input<io.pulumi.kubernetes.node.v1beta1.inputs.SchedulingArgs> getScheduling() {
    ...
    public RuntimeClassArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.OverheadArgs> overhead,
        @Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.SchedulingArgs> scheduling) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.OverheadArgs> overhead;
        private @Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.SchedulingArgs> scheduling;
        ...
        public Builder setOverhead(@Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.OverheadArgs> overhead) {
            this.overhead = overhead;
            return this;
        }

        public Builder setOverhead(@Nullable io.pulumi.kubernetes.node.v1beta1.inputs.OverheadArgs overhead) {
            this.overhead = Input.ofNullable(overhead);
            return this;
        }

        public Builder setScheduling(@Nullable Input<io.pulumi.kubernetes.node.v1beta1.inputs.SchedulingArgs> scheduling) {
            this.scheduling = scheduling;
            return this;
        }

        public Builder setScheduling(@Nullable io.pulumi.kubernetes.node.v1beta1.inputs.SchedulingArgs scheduling) {
