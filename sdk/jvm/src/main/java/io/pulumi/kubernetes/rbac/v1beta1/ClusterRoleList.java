...
public class ClusterRoleList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.rbac.v1beta1.outputs.ClusterRole.class})
    private Output<List<io.pulumi.kubernetes.rbac.v1beta1.outputs.ClusterRole>> items;

    public Output<List<io.pulumi.kubernetes.rbac.v1beta1.outputs.ClusterRole>> getItems() {
        return this.items;
    }
