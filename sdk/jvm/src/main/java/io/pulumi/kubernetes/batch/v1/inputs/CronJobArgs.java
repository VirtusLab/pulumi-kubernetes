...
public final class CronJobArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.batch.v1.inputs.CronJobSpecArgs> spec;

    public Input<io.pulumi.kubernetes.batch.v1.inputs.CronJobSpecArgs> getSpec() {
    ...
    public CronJobArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.batch.v1.inputs.CronJobSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.batch.v1.inputs.CronJobSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.batch.v1.inputs.CronJobSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.batch.v1.inputs.CronJobSpecArgs spec) {
