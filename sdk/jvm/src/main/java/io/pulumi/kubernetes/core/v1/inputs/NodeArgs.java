...
public final class NodeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.NodeSpecArgs> getSpec() {
    ...
    public NodeArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.NodeSpecArgs spec) {
