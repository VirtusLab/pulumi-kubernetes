...
public final class TokenReviewArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.authentication.v1beta1.inputs.TokenReviewSpecArgs> spec;

    public Input<io.pulumi.kubernetes.authentication.v1beta1.inputs.TokenReviewSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public TokenReviewArgs(
        ...
        Input<io.pulumi.kubernetes.authentication.v1beta1.inputs.TokenReviewSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.authentication.v1beta1.inputs.TokenReviewSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.authentication.v1beta1.inputs.TokenReviewSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.authentication.v1beta1.inputs.TokenReviewSpecArgs spec) {
