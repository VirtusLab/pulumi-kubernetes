...
public class JobList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.batch.v1.outputs.Job.class})
    private Output<List<io.pulumi.kubernetes.batch.v1.outputs.Job>> items;

    public Output<List<io.pulumi.kubernetes.batch.v1.outputs.Job>> getItems() {
        return this.items;
    }
