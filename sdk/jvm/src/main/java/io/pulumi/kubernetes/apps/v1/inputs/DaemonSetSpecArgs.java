...
public final class DaemonSetSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetUpdateStrategyArgs> updateStrategy;

    public Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetUpdateStrategyArgs> getUpdateStrategy() {
    ...
    public DaemonSetSpecArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetUpdateStrategyArgs> updateStrategy) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetUpdateStrategyArgs> updateStrategy;
        ...
        public Builder setUpdateStrategy(@Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetUpdateStrategyArgs> updateStrategy) {
            this.updateStrategy = updateStrategy;
            return this;
        }

        public Builder setUpdateStrategy(@Nullable io.pulumi.kubernetes.apps.v1.inputs.DaemonSetUpdateStrategyArgs updateStrategy) {
