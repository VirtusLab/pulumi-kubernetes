...
public final class CSIDriverArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.storage.v1beta1.inputs.CSIDriverSpecArgs> spec;

    public Input<io.pulumi.kubernetes.storage.v1beta1.inputs.CSIDriverSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public CSIDriverArgs(
        ...
        Input<io.pulumi.kubernetes.storage.v1beta1.inputs.CSIDriverSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.storage.v1beta1.inputs.CSIDriverSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.storage.v1beta1.inputs.CSIDriverSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.storage.v1beta1.inputs.CSIDriverSpecArgs spec) {
