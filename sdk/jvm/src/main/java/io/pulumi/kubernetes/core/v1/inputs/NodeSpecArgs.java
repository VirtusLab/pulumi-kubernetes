...
public final class NodeSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeConfigSourceArgs> configSource;

    public Input<io.pulumi.kubernetes.core.v1.inputs.NodeConfigSourceArgs> getConfigSource() {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TaintArgs>> taints;

    public Input<List<io.pulumi.kubernetes.core.v1.inputs.TaintArgs>> getTaints() {
    ...
    public NodeSpecArgs(
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeConfigSourceArgs> configSource,
        ...
        @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TaintArgs>> taints,
    ...
    public static final class Builder {
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeConfigSourceArgs> configSource;
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TaintArgs>> taints;
        ...
        public Builder setConfigSource(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.NodeConfigSourceArgs> configSource) {
            this.configSource = configSource;
            return this;
        }

        public Builder setConfigSource(@Nullable io.pulumi.kubernetes.core.v1.inputs.NodeConfigSourceArgs configSource) {
        ...
        public Builder setTaints(@Nullable Input<List<io.pulumi.kubernetes.core.v1.inputs.TaintArgs>> taints) {
            this.taints = taints;
            return this;
        }

        public Builder setTaints(@Nullable List<io.pulumi.kubernetes.core.v1.inputs.TaintArgs> taints) {
