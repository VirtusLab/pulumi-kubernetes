...
public final class DeploymentSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollbackConfigArgs> rollbackTo;

    public Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollbackConfigArgs> getRollbackTo() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.DeploymentStrategyArgs> strategy;

    public Input<io.pulumi.kubernetes.apps.v1beta1.inputs.DeploymentStrategyArgs> getStrategy() {
    ...
    public DeploymentSpecArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollbackConfigArgs> rollbackTo,
        @Nullable Input<io.pulumi.kubernetes.meta.v1.inputs.LabelSelectorArgs> selector,
        @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.DeploymentStrategyArgs> strategy,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollbackConfigArgs> rollbackTo;
        private @Nullable Input<io.pulumi.kubernetes.meta.v1.inputs.LabelSelectorArgs> selector;
        private @Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.DeploymentStrategyArgs> strategy;
        ...
        public Builder setRollbackTo(@Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.RollbackConfigArgs> rollbackTo) {
            this.rollbackTo = rollbackTo;
            return this;
        }

        public Builder setRollbackTo(@Nullable io.pulumi.kubernetes.apps.v1beta1.inputs.RollbackConfigArgs rollbackTo) {
        ...
        public Builder setStrategy(@Nullable Input<io.pulumi.kubernetes.apps.v1beta1.inputs.DeploymentStrategyArgs> strategy) {
            this.strategy = strategy;
            return this;
        }

        public Builder setStrategy(@Nullable io.pulumi.kubernetes.apps.v1beta1.inputs.DeploymentStrategyArgs strategy) {
