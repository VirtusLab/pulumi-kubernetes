...
public final class DaemonSetStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DaemonSetConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DaemonSetConditionArgs>> getConditions() {
    ...
    public DaemonSetStatusArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DaemonSetConditionArgs>> conditions,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DaemonSetConditionArgs>> conditions;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.apps.v1beta2.inputs.DaemonSetConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.apps.v1beta2.inputs.DaemonSetConditionArgs> conditions) {
