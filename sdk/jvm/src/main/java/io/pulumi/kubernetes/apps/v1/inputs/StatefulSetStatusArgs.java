...
public final class StatefulSetStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetConditionArgs>> getConditions() {
    ...
    public StatefulSetStatusArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetConditionArgs>> conditions,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetConditionArgs>> conditions;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.apps.v1.inputs.StatefulSetConditionArgs> conditions) {
