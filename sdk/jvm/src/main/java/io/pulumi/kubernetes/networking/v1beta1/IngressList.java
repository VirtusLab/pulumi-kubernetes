...
public class IngressList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.networking.v1beta1.outputs.Ingress.class})
    private Output<List<io.pulumi.kubernetes.networking.v1beta1.outputs.Ingress>> items;

    public Output<List<io.pulumi.kubernetes.networking.v1beta1.outputs.Ingress>> getItems() {
        return this.items;
    }
