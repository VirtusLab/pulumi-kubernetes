...
public class Deployment extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.apps.v1beta1.outputs.DeploymentSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.apps.v1beta1.outputs.DeploymentSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.apps.v1beta1.outputs.DeploymentSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.apps.v1beta1.outputs.DeploymentStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.apps.v1beta1.outputs.DeploymentStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.apps.v1beta1.outputs.DeploymentStatus> getStatus() {
        return this.status;
    }
