...
public class ValidatingWebhookConfigurationList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhookConfiguration.class})
    private Output<List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhookConfiguration>> items;

    public Output<List<io.pulumi.kubernetes.admissionregistration.v1beta1.outputs.ValidatingWebhookConfiguration>> getItems() {
        return this.items;
    }
    ...
    public ValidatingWebhookConfigurationList(String name, ValidatingWebhookConfigurationListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingWebhookConfigurationList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
