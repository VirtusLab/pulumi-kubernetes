...
public final class PodSecurityPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.PodSecurityPolicySpecArgs> spec;

    public Input<io.pulumi.kubernetes.policy.v1beta1.inputs.PodSecurityPolicySpecArgs> getSpec() {
    ...
    public PodSecurityPolicyArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.PodSecurityPolicySpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.PodSecurityPolicySpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.policy.v1beta1.inputs.PodSecurityPolicySpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.policy.v1beta1.inputs.PodSecurityPolicySpecArgs spec) {
