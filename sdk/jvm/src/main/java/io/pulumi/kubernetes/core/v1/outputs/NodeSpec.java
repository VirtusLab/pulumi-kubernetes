...
public final class NodeSpec {
    private final @Nullable io.pulumi.kubernetes.core.v1.outputs.NodeConfigSource configSource;
    ...
    private final @Nullable List<io.pulumi.kubernetes.core.v1.outputs.Taint> taints;
    ...
    private NodeSpec(
        @Nullable io.pulumi.kubernetes.core.v1.outputs.NodeConfigSource configSource,
        @Nullable String externalID,
        @Nullable String podCIDR,
        @Nullable List<String> podCIDRs,
        @Nullable String providerID,
        @Nullable List<io.pulumi.kubernetes.core.v1.outputs.Taint> taints,
    ...
    public Optional<io.pulumi.kubernetes.core.v1.outputs.NodeConfigSource> getConfigSource() {
    ...
    public List<io.pulumi.kubernetes.core.v1.outputs.Taint> getTaints() {
    ...
    public static final class Builder {
        private @Nullable io.pulumi.kubernetes.core.v1.outputs.NodeConfigSource configSource;
        private @Nullable String externalID;
        private @Nullable String podCIDR;
        private @Nullable List<String> podCIDRs;
        private @Nullable String providerID;
        private @Nullable List<io.pulumi.kubernetes.core.v1.outputs.Taint> taints;
        ...
        public Builder setConfigSource(@Nullable io.pulumi.kubernetes.core.v1.outputs.NodeConfigSource configSource) {
            this.configSource = configSource;
            return this;
        }
        ...
        public Builder setTaints(@Nullable List<io.pulumi.kubernetes.core.v1.outputs.Taint> taints) {
            this.taints = taints;
            return this;
        }
