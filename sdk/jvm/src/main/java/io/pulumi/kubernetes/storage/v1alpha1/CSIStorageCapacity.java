...
public class CSIStorageCapacity extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="nodeTopology", type=io.pulumi.kubernetes.meta.v1.outputs.LabelSelector.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.meta.v1.outputs.LabelSelector> nodeTopology;

    public Output</* @Nullable */ io.pulumi.kubernetes.meta.v1.outputs.LabelSelector> getNodeTopology() {
