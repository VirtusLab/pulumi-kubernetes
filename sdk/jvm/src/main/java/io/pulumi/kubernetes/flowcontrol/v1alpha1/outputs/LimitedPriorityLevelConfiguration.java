...
public final class LimitedPriorityLevelConfiguration {
    ...
    private final @Nullable io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.LimitResponse limitResponse;
    ...
    private LimitedPriorityLevelConfiguration(
        ...
        @Nullable io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.LimitResponse limitResponse) {
    ...
    public Optional<io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.LimitResponse> getLimitResponse() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.LimitResponse limitResponse;
        ...
        public Builder setLimitResponse(@Nullable io.pulumi.kubernetes.flowcontrol.v1alpha1.outputs.LimitResponse limitResponse) {
            this.limitResponse = limitResponse;
            return this;
        }
