...
public final class PodTemplateSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PodSpecArgs> spec;

    public Input<io.pulumi.kubernetes.core.v1.inputs.PodSpecArgs> getSpec() {
        return this.spec == null ? Input.empty() : this.spec;
    }

    public PodTemplateSpecArgs(
        @Nullable Input<io.pulumi.kubernetes.meta.v1.inputs.ObjectMetaArgs> metadata,
        @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PodSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PodSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.core.v1.inputs.PodSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.core.v1.inputs.PodSpecArgs spec) {
