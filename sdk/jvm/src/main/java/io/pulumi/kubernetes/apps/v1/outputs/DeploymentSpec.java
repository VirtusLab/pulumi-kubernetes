...
public final class DeploymentSpec {
    ...
    private final @Nullable io.pulumi.kubernetes.apps.v1.outputs.DeploymentStrategy strategy;
    ...
    private DeploymentSpec(
        ...
        @Nullable io.pulumi.kubernetes.apps.v1.outputs.DeploymentStrategy strategy,
    ...
    public Optional<io.pulumi.kubernetes.apps.v1.outputs.DeploymentStrategy> getStrategy() {
    ...
    public static final class Builder {
        ...
        private @Nullable io.pulumi.kubernetes.apps.v1.outputs.DeploymentStrategy strategy;
        ...
        public Builder setStrategy(@Nullable io.pulumi.kubernetes.apps.v1.outputs.DeploymentStrategy strategy) {
            this.strategy = strategy;
            return this;
        }
