...
public final class APIServiceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apiregistration.v1.inputs.APIServiceSpecArgs> spec;

    public Input<io.pulumi.kubernetes.apiregistration.v1.inputs.APIServiceSpecArgs> getSpec() {
    ...
    public APIServiceArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apiregistration.v1.inputs.APIServiceSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apiregistration.v1.inputs.APIServiceSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.apiregistration.v1.inputs.APIServiceSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.apiregistration.v1.inputs.APIServiceSpecArgs spec) {
