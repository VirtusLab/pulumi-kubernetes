...
package io.pulumi.kubernetes.apiextensions.v1;
...
import io.pulumi.kubernetes.apiextensions.v1.inputs.*;
...
public class CustomResourceDefinition extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.apiextensions.v1.outputs.CustomResourceDefinitionSpec.class, parameters={})
    private Output<io.pulumi.kubernetes.apiextensions.v1.outputs.CustomResourceDefinitionSpec> spec;

    public Output<io.pulumi.kubernetes.apiextensions.v1.outputs.CustomResourceDefinitionSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.apiextensions.v1.outputs.CustomResourceDefinitionStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.apiextensions.v1.outputs.CustomResourceDefinitionStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.apiextensions.v1.outputs.CustomResourceDefinitionStatus> getStatus() {
        return this.status;
    }
