...
public final class DaemonSetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetSpecArgs> spec;

    public Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetSpecArgs> getSpec() {
    ...
    public DaemonSetArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.apps.v1.inputs.DaemonSetSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.apps.v1.inputs.DaemonSetSpecArgs spec) {
