...
public final class DeploymentStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentConditionArgs>> getConditions() {
    ...
    public DeploymentStatusArgs(
        ...
        @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentConditionArgs>> conditions,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentConditionArgs>> conditions;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.extensions.v1beta1.inputs.DeploymentConditionArgs> conditions) {
