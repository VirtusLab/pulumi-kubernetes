...
public class PodDisruptionBudgetList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.policy.v1beta1.outputs.PodDisruptionBudget.class})
    private Output<List<io.pulumi.kubernetes.policy.v1beta1.outputs.PodDisruptionBudget>> items;

    public Output<List<io.pulumi.kubernetes.policy.v1beta1.outputs.PodDisruptionBudget>> getItems() {
        return this.items;
    }
