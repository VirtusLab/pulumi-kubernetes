...
public class TokenReview extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.authentication.v1.outputs.TokenReviewSpec.class, parameters={})
    private Output<io.pulumi.kubernetes.authentication.v1.outputs.TokenReviewSpec> spec;

    public Output<io.pulumi.kubernetes.authentication.v1.outputs.TokenReviewSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.authentication.v1.outputs.TokenReviewStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.authentication.v1.outputs.TokenReviewStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.authentication.v1.outputs.TokenReviewStatus> getStatus() {
        return this.status;
    }
