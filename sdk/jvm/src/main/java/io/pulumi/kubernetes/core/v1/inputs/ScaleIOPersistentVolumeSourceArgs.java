...
public final class ScaleIOPersistentVolumeSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.core.v1.inputs.SecretReferenceArgs> secretRef;
    ...
    public ScaleIOPersistentVolumeSourceArgs(
        ...
        Input<io.pulumi.kubernetes.core.v1.inputs.SecretReferenceArgs> secretRef,
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.core.v1.inputs.SecretReferenceArgs> secretRef;
        ...
        public Builder setSecretRef(Input<io.pulumi.kubernetes.core.v1.inputs.SecretReferenceArgs> secretRef) {
            this.secretRef = Objects.requireNonNull(secretRef);
            return this;
        }

        public Builder setSecretRef(io.pulumi.kubernetes.core.v1.inputs.SecretReferenceArgs secretRef) {
