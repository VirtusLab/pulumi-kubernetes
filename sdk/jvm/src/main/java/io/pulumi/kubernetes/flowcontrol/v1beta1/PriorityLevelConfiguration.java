...
package io.pulumi.kubernetes.flowcontrol.v1beta1;
...
import io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.*;
...
public class PriorityLevelConfiguration extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfigurationSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfigurationSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfigurationSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfigurationStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfigurationStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.flowcontrol.v1beta1.outputs.PriorityLevelConfigurationStatus> getStatus() {
        return this.status;
    }
