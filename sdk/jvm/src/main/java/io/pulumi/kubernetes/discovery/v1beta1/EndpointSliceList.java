...
public class EndpointSliceList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointSlice.class})
    private Output<List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointSlice>> items;

    public Output<List<io.pulumi.kubernetes.discovery.v1beta1.outputs.EndpointSlice>> getItems() {
        return this.items;
    }
