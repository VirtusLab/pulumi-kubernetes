...
package io.pulumi.kubernetes.certificates.v1beta1.inputs;
...
public final class CertificateSigningRequestStatusArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestConditionArgs>> conditions;

    public Input<List<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestConditionArgs>> getConditions() {
        return this.conditions == null ? Input.empty() : this.conditions;
    }

    public CertificateSigningRequestStatusArgs(
        @Nullable Input<String> certificate,
        @Nullable Input<List<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestConditionArgs>> conditions) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestConditionArgs>> conditions;
        ...
        public Builder setConditions(@Nullable Input<List<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestConditionArgs>> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.certificates.v1beta1.inputs.CertificateSigningRequestConditionArgs> conditions) {
