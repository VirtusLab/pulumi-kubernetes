...
public final class RunAsUserStrategyOptionsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.IDRangeArgs>> ranges;

    public Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.IDRangeArgs>> getRanges() {
    ...
    public RunAsUserStrategyOptionsArgs(
        @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.IDRangeArgs>> ranges,
        Input<String> rule) {
        this.ranges = ranges;
    ...
    public static final class Builder {
        private @Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.IDRangeArgs>> ranges;
        ...
        public Builder setRanges(@Nullable Input<List<io.pulumi.kubernetes.extensions.v1beta1.inputs.IDRangeArgs>> ranges) {
            this.ranges = ranges;
            return this;
        }

        public Builder setRanges(@Nullable List<io.pulumi.kubernetes.extensions.v1beta1.inputs.IDRangeArgs> ranges) {
