...
public final class StorageClass {
    ...
    private final @Nullable List<io.pulumi.kubernetes.core.v1.outputs.TopologySelectorTerm> allowedTopologies;
    ...
    private StorageClass(
        ...
        @Nullable List<io.pulumi.kubernetes.core.v1.outputs.TopologySelectorTerm> allowedTopologies,
    ...
    public List<io.pulumi.kubernetes.core.v1.outputs.TopologySelectorTerm> getAllowedTopologies() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.core.v1.outputs.TopologySelectorTerm> allowedTopologies;
        ...
        public Builder setAllowedTopologies(@Nullable List<io.pulumi.kubernetes.core.v1.outputs.TopologySelectorTerm> allowedTopologies) {
            this.allowedTopologies = allowedTopologies;
            return this;
        }
