...
public final class HorizontalPodAutoscalerListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs>> items;

    public Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs>> getItems() {
        return this.items;
    }
    ...
    public HorizontalPodAutoscalerListArgs(
        ...
        Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs>> items;
        ...
        public Builder setItems(Input<List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerArgs> items) {
