...
public final class ClusterRoleBinding {
    ...
    private final io.pulumi.kubernetes.rbac.v1alpha1.outputs.RoleRef roleRef;
    private final @Nullable List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Subject> subjects;
    ...
    private ClusterRoleBinding(
        ...
        io.pulumi.kubernetes.rbac.v1alpha1.outputs.RoleRef roleRef,
        @Nullable List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Subject> subjects) {
    ...
    public io.pulumi.kubernetes.rbac.v1alpha1.outputs.RoleRef getRoleRef() {
        return this.roleRef;
    }
    public List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Subject> getSubjects() {
    ...
    public static final class Builder {
        ...
        private io.pulumi.kubernetes.rbac.v1alpha1.outputs.RoleRef roleRef;
        private @Nullable List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Subject> subjects;
        ...
        public Builder setRoleRef(io.pulumi.kubernetes.rbac.v1alpha1.outputs.RoleRef roleRef) {
            this.roleRef = Objects.requireNonNull(roleRef);
            return this;
        }

        public Builder setSubjects(@Nullable List<io.pulumi.kubernetes.rbac.v1alpha1.outputs.Subject> subjects) {
            this.subjects = subjects;
            return this;
        }
