...
public class SelfSubjectAccessReview extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.authorization.v1.outputs.SelfSubjectAccessReviewSpec.class, parameters={})
    private Output<io.pulumi.kubernetes.authorization.v1.outputs.SelfSubjectAccessReviewSpec> spec;

    public Output<io.pulumi.kubernetes.authorization.v1.outputs.SelfSubjectAccessReviewSpec> getSpec() {
        return this.spec;
    }
