...
public class ClusterRoleBindingList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.rbac.v1beta1.outputs.ClusterRoleBinding.class})
    private Output<List<io.pulumi.kubernetes.rbac.v1beta1.outputs.ClusterRoleBinding>> items;

    public Output<List<io.pulumi.kubernetes.rbac.v1beta1.outputs.ClusterRoleBinding>> getItems() {
        return this.items;
    }
