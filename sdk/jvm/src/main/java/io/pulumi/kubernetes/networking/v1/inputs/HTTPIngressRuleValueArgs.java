...
public final class HTTPIngressRuleValueArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<io.pulumi.kubernetes.networking.v1.inputs.HTTPIngressPathArgs>> paths;

    public Input<List<io.pulumi.kubernetes.networking.v1.inputs.HTTPIngressPathArgs>> getPaths() {
        return this.paths;
    }

    public HTTPIngressRuleValueArgs(Input<List<io.pulumi.kubernetes.networking.v1.inputs.HTTPIngressPathArgs>> paths) {
    ...
    public static final class Builder {
        private Input<List<io.pulumi.kubernetes.networking.v1.inputs.HTTPIngressPathArgs>> paths;
        ...
        public Builder setPaths(Input<List<io.pulumi.kubernetes.networking.v1.inputs.HTTPIngressPathArgs>> paths) {
            this.paths = Objects.requireNonNull(paths);
            return this;
        }

        public Builder setPaths(List<io.pulumi.kubernetes.networking.v1.inputs.HTTPIngressPathArgs> paths) {
