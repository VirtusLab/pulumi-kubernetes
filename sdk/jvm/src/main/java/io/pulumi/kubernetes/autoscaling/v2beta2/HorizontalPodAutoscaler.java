...
package io.pulumi.kubernetes.autoscaling.v2beta2;
...
import io.pulumi.kubernetes.autoscaling.v2beta2.inputs.*;
...
public class HorizontalPodAutoscaler extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="spec", type=io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscalerSpec.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscalerSpec> spec;

    public Output</* @Nullable */ io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscalerSpec> getSpec() {
        return this.spec;
    }
    @OutputExport(name="status", type=io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscalerStatus.class, parameters={})
    private Output</* @Nullable */ io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscalerStatus> status;

    public Output</* @Nullable */ io.pulumi.kubernetes.autoscaling.v2beta2.outputs.HorizontalPodAutoscalerStatus> getStatus() {
        return this.status;
    }
