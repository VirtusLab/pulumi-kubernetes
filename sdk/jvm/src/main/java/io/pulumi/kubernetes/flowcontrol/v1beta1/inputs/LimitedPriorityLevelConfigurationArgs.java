...
public final class LimitedPriorityLevelConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.LimitResponseArgs> limitResponse;

    public Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.LimitResponseArgs> getLimitResponse() {
    ...
    public LimitedPriorityLevelConfigurationArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.LimitResponseArgs> limitResponse) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.LimitResponseArgs> limitResponse;
        ...
        public Builder setLimitResponse(@Nullable Input<io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.LimitResponseArgs> limitResponse) {
            this.limitResponse = limitResponse;
            return this;
        }

        public Builder setLimitResponse(@Nullable io.pulumi.kubernetes.flowcontrol.v1beta1.inputs.LimitResponseArgs limitResponse) {
