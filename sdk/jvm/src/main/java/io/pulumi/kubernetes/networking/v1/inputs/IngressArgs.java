...
public final class IngressArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressSpecArgs> spec;

    public Input<io.pulumi.kubernetes.networking.v1.inputs.IngressSpecArgs> getSpec() {
    ...
    public IngressArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.networking.v1.inputs.IngressSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.networking.v1.inputs.IngressSpecArgs spec) {
