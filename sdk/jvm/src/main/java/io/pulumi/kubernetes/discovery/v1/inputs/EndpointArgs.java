...
public final class EndpointArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointConditionsArgs> conditions;

    public Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointConditionsArgs> getConditions() {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointHintsArgs> hints;

    public Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointHintsArgs> getHints() {
    ...
    public EndpointArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointConditionsArgs> conditions,
        @Nullable Input<Map<String,String>> deprecatedTopology,
        @Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointHintsArgs> hints,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointConditionsArgs> conditions;
        private @Nullable Input<Map<String,String>> deprecatedTopology;
        private @Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointHintsArgs> hints;
        ...
        public Builder setConditions(@Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointConditionsArgs> conditions) {
            this.conditions = conditions;
            return this;
        }

        public Builder setConditions(@Nullable io.pulumi.kubernetes.discovery.v1.inputs.EndpointConditionsArgs conditions) {
        ...
        public Builder setHints(@Nullable Input<io.pulumi.kubernetes.discovery.v1.inputs.EndpointHintsArgs> hints) {
            this.hints = hints;
            return this;
        }

        public Builder setHints(@Nullable io.pulumi.kubernetes.discovery.v1.inputs.EndpointHintsArgs hints) {
