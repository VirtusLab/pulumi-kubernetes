...
public class StatefulSetList extends io.pulumi.kubernetes.KubernetesResource {
    ...
    @OutputExport(name="items", type=List.class, parameters={io.pulumi.kubernetes.apps.v1.outputs.StatefulSet.class})
    private Output<List<io.pulumi.kubernetes.apps.v1.outputs.StatefulSet>> items;

    public Output<List<io.pulumi.kubernetes.apps.v1.outputs.StatefulSet>> getItems() {
        return this.items;
    }
    ...
    public StatefulSetList(String name, StatefulSetListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:StatefulSetList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
