...
public final class ReplicaSetStatus {
    ...
    private final @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSetCondition> conditions;
    ...
    private ReplicaSetStatus(
        ...
        @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSetCondition> conditions,
    ...
    public List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSetCondition> getConditions() {
    ...
    public static final class Builder {
        ...
        private @Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSetCondition> conditions;
        ...
        public Builder setConditions(@Nullable List<io.pulumi.kubernetes.extensions.v1beta1.outputs.ReplicaSetCondition> conditions) {
            this.conditions = conditions;
            return this;
        }
