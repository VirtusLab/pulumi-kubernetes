...
public final class HorizontalPodAutoscalerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerSpecArgs> spec;

    public Input<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerSpecArgs> getSpec() {
    ...
    public HorizontalPodAutoscalerArgs(
        ...
        @Nullable Input<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable io.pulumi.kubernetes.autoscaling.v2beta2.inputs.HorizontalPodAutoscalerSpecArgs spec) {
