...
public final class CronJobSpec {
    ...
    private final io.pulumi.kubernetes.batch.v2alpha1.outputs.JobTemplateSpec jobTemplate;
    ...
    private CronJobSpec(
        ...
        io.pulumi.kubernetes.batch.v2alpha1.outputs.JobTemplateSpec jobTemplate,
        String schedule,
    ...
    public io.pulumi.kubernetes.batch.v2alpha1.outputs.JobTemplateSpec getJobTemplate() {
    ...
    public static final class Builder {
        ...
        private io.pulumi.kubernetes.batch.v2alpha1.outputs.JobTemplateSpec jobTemplate;
        ...
        public Builder setJobTemplate(io.pulumi.kubernetes.batch.v2alpha1.outputs.JobTemplateSpec jobTemplate) {
            this.jobTemplate = Objects.requireNonNull(jobTemplate);
            return this;
        }
