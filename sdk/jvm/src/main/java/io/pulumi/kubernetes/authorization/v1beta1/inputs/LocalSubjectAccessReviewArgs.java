...
public final class LocalSubjectAccessReviewArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SubjectAccessReviewSpecArgs> spec;

    public Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SubjectAccessReviewSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public LocalSubjectAccessReviewArgs(
        ...
        Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SubjectAccessReviewSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SubjectAccessReviewSpecArgs> spec;
        ...
        public Builder setSpec(Input<io.pulumi.kubernetes.authorization.v1beta1.inputs.SubjectAccessReviewSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(io.pulumi.kubernetes.authorization.v1beta1.inputs.SubjectAccessReviewSpecArgs spec) {
